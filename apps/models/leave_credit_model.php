...
class leave_credit_model extends Record
{
	var $mod_id;
	var $mod_code;
	var $route;
	...
	{
		$this->mod_id = 181;
		$this->mod_code = 'leave_credit';
		$this->route = 'time/leave_credit';
		$this->url = site_url('time/leave_credit');
		$this->primary_key = 'id';
		...
		$this->description = '';
		$this->path = APPPATH . 'modules/leave_credit/';
