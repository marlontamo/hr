...
class hearing_model extends Record
{
	var $mod_id;
	var $mod_code;
	var $route;
	...
	{
		$this->mod_id = 153;
		$this->mod_code = 'hearing';
		$this->route = 'partner/hearing';
		$this->url = site_url('partner/hearing');
		...
		$this->description = '';
		$this->path = APPPATH . 'modules/hearing/';
	...
	function _get_list($start, $limit, $search, $filter, $trash = false)
	{
		...
		// {
			$qry .= " AND {$this->db->dbprefix}{$this->table}.incident_status_id IN (6,10) ";
		// }
