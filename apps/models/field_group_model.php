...
class field_group_model extends Record
{
	var $mod_id;
	var $mod_code;
	var $route;
	...
	{
		$this->mod_id = 8;
		$this->mod_code = 'field_group';
		$this->route = 'admin/field_groups';
		$this->url = site_url('admin/field_groups');
		$this->primary_key = 'fg_id';
		$this->table = 'fieldgroups';
		$this->icon = 'fa-fg';
		$this->short_name = 'Field Groups';
		$this->long_name  = 'Field Groups';
		$this->description = 'contains list of field groups of modules of the system.';
		$this->path = APPPATH . 'modules/field_group/';
	...
	function _save_fg()
	{
        ...
        $response->saved = true; 
		$response->message[] = array(
            'message' => lang('field_group.field_saved'),
            'type' => 'success'
        );
