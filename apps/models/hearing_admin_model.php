...
class hearing_admin_model extends Record
{
	var $mod_id;
	var $mod_code;
	var $route;
	...
	{
		$this->mod_id = 155;
		$this->mod_code = 'hearing_admin';
		$this->route = 'partner/hearing_admin';
		$this->url = site_url('partner/hearing_admin');
		...
		$this->description = '';
		$this->path = APPPATH . 'modules/hearing_admin/';
