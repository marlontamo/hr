...
class leave_filed_period_admin_model extends Record
{
	var $mod_id;
	var $mod_code;
	var $route;
	...
	{
		$this->mod_id = 186;
		$this->mod_code = 'leave_filed_period_admin';
		$this->route = 'time/leave_filed_period_admin';
		$this->url = site_url('time/leave_filed_period_admin');
		...
		$this->description = '';
		$this->path = APPPATH . 'modules/leave_filed_period_admin/';
