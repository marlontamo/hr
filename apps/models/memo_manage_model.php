...
class memo_manage_model extends Record
{
	var $mod_id;
	var $mod_code;
	var $route;
	...
	{
		$this->mod_id = 166;
		$this->mod_code = 'memo_manage';
		$this->route = 'partners/memo_manage';
		$this->url = site_url('partners/memo_manage');
		$this->primary_key = 'memo_id';
		$this->table = 'memo';
		$this->icon = '';
		$this->short_name = 'Memo Manage';
		$this->long_name  = 'Memo Manage';
		$this->description = '';
		$this->path = APPPATH . 'modules/memo_manage/';
	...
	function _get_list($start, $limit, $search, $filter, $trash = false)
	{
		...
		$qry .= " AND created_by = {$this->user->user_id} ";
		$qry .= ' '. $filter;
