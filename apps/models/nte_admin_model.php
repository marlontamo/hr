...
class nte_admin_model extends Record
{
	var $mod_id;
	var $mod_code;
	var $route;
	...
	{
		$this->mod_id = 152;
		$this->mod_code = 'nte_admin';
		$this->route = 'partner/nte_admin';
		$this->url = site_url('partner/nte_admin');
		...
		$this->description = '';
		$this->path = APPPATH . 'modules/nte_admin/';
	...
	function _get_list($start, $limit, $search, $filter, $trash = false)
	{
		...
		switch ($this->coc_process) {
			case 'immediate':
				$qry .= " AND {$this->db->dbprefix}{$this->table}.incident_status_id IN (6) ";
				break;
			default:
