...
class addtl_usage_model extends Record
{
	var $mod_id;
	var $mod_code;
	var $route;
	...
	{
		$this->mod_id = 184;
		$this->mod_code = 'addtl_usage';
		$this->route = 'time/addtl_usage';
		$this->url = site_url('time/addtl_usage');
		$this->primary_key = 'forms_id';
		$this->table = 'time_forms';
		$this->icon = '';
		$this->short_name = 'Additional Leave - Usage';
		$this->long_name  = 'Additional Leave - Usage';
		$this->description = '';
		$this->path = APPPATH . 'modules/addtl_usage/';
