...
class leave_filed_period_model extends Record
{
	var $mod_id;
	var $mod_code;
	var $route;
	...
	{
		$this->mod_id = 182;
		$this->mod_code = 'leave_filed_period';
		$this->route = 'time/leave_filed_period';
		$this->url = site_url('time/leave_filed_period');
		...
		$this->description = '';
		$this->path = APPPATH . 'modules/leave_filed_period/';
