			...
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						@if ($incident_report)
						<li class="active"><a href="{{ get_mod_route('incident_report') }}">{{ lang('common.personal') }}</a></li>
						@endif
						@if ($incident_manage)
						<li class=""><a href="{{ get_mod_route('incident_manage') }}">{{ lang('common.manage') }}</a></li>
						@endif
						@if ($incident_admin)
						<li class=""><a href="{{ get_mod_route('incident_admin') }}">{{ lang('common.admin') }}</a></li>
						@endif
					</ul>
				</div>
			</div>
