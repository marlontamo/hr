<div class="portlet">
	...
	<div class="portlet-body">
		...
		<div class="margin-top-15">
			...
			<span  href="javascript:void(0)" class="filter-type event-block label label-default" filter_by="ww_performance_competency_libraries.competency_category_id" filter_value="{{$competency_category->competency_category_id}}">{{$competency_category->competency_category}}</span>
			@endforeach
