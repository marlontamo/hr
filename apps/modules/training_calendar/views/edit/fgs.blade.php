	...
	<div class="portlet">
		...
		<div class="portlet-body form">
			...
			<div class="form-group">
				...
				<div class="col-md-7">							
					<input type="text" class="form-control" name="training_calendar[provider]" id="training_calendar-calendar_type_id" value="<?php echo !empty($record['training_calendar.course_id']) ? $training_provider : ''; ?>" placeholder="Enter Training Provider" readonly/> 				
				</div>	 
			</div>
