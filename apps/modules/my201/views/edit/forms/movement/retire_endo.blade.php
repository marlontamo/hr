<div class="form-group">
	...
	<div class="col-md-7">							
		<div class="input-group input-medium " data-date-format="MM dd, yyyy">
			<input type="text" disabled class="form-control" name="partners_movement_action_moving[end_date]" 
...
<div class="form-group">
	...
	<div class="col-md-7">							
		<div class="make-switch" data-on-label="&nbsp;Yes&nbsp;" data-off-label="&nbsp;No&nbsp;">
			<input type="checkbox" disabled value="1" <?php if ( $record['partners_movement_action_moving.blacklisted'] ){ echo "checked='checked'"; } ?> 
