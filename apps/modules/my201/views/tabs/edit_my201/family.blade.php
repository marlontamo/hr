        ...
        <div class="portlet">
            ...
            <div class="portlet-title">
                <div class="caption" id="family-relationship">
                    ...
                    <?php echo array_key_exists('family-relationship', $family) ? $family['family-relationship'] : ""; ?>
                </div>
                <div class="tools">
                    ...
                    <div class="form-horizontal">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" class="form-control" {{ ($is_editable['family-name'] == 1) ? '' : 'readonly="readonly"' }} name="partners_personal_history[family-name][]" id="partners_personal_history-family-name<?php echo$count_family ?>" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <div class="make-switch" data-on-label="&nbsp;Yes&nbsp;" data-off-label="&nbsp;No&nbsp;">
                                        <input type="checkbox" disabled  value="1" {{ ( array_key_exists('family-dependent', $family) ? $family['family-dependent'] : "" ) ? '' : 'checked="checked"' }} name="partners_personal_history[family-dependent][temp][]" id="partners_personal_history-family-dependent-temp" class="dontserializeme toggle dependent"/>
                                        <input type="hidden" name="partners_personal_history[family-dependent][]" id="partners_personal_history-family-dependent" value="{{ ( array_key_exists('family-dependent', $family) ? $family['family-dependent'] : '' ) ? 0 : 1 }}"/>
                                    </div> 
                                </div>
                            </div>
                            @endif
