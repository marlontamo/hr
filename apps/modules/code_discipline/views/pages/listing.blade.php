		...
		<div class="col-md-9">
			<div class="portlet">
				<div class="portlet-body">
					<div >
						<ul class="nav nav-tabs ">
							@if ($offense)
							<li class="active"><a href="{{ get_mod_route('code_discipline') }}">{{ lang('code_discipline.offense') }}</a></li>
							@endif
							@if ($sanction)
							<li class=""><a href="{{ get_mod_route('offense_sanction') }}">{{ lang('code_discipline.sanction') }}</a></li>
							@endif
						</ul>
					</div>
				</div>
				...
				<div class="portlet-title">
					<div class="caption"><i class="fa {{ $mod->icon}}"></i>{{ lang('code_discipline.list_of') }} {{ $mod->short_name }}</div>
