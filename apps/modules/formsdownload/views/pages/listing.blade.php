			...
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						@if ($policies)
						<li class="active"><a href="{{ get_mod_route('formsdownload') }}">{{ lang('common.personal') }}</a></li>
						@endif
						@if ($policies_admin)
						<li class=""><a href="{{ get_mod_route('formsdownload_admin') }}">{{ lang('common.admin') }}</a></li>
						@endif
					</ul>
				</div>
			</div>
