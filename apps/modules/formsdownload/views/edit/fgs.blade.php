<div class="portlet">
	<div class="portlet-title">
		<div class="caption">{{ lang('formsdownload.dl_forms') }}</div>
		<div class="tools"><a class="collapse" href="javascript:;"></a></div>
	</div>
		<div class="portlet-body form">			<div class="form-group">
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('formsdownload.title') }}</label>
				...
				<label class="control-label col-md-3">{{ lang('formsdownload.category') }}</label>
				...
				<label class="control-label col-md-3">{{ lang('formsdownload.description') }}</label>
				...
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('formsdownload.attachments') }}</label>
				<div class="col-md-7">							<div data-provides="fileupload" class="fileupload fileupload-new" id="resources_downloadable-attachments-container">
								...
								<div class="input-group">
									...
									<span class="btn default btn-file">
										<span class="fileupload-new"><i class="fa fa-paper-clip"></i> {{ lang('formsdownload.select_file') }}</span>
