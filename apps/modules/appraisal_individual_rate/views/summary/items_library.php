			...
			switch( $col->uitype_id )
			{
				case 3: 
					if( $size > 0 )
					{
						...
						<td>
							<textarea class="form-control" rows="1" name="appraisal_field[<?php echo $col->section_column_id?>][<?php echo $child->item_id?>]" readonly><?php echo $value?></textarea>
						</td>
						<?php
					}
					else{
						...
						if($tripart){ ?>
							...
							<td>
								<textarea class="form-control" rows="1" name="appraisal_field[<?php echo $col->section_column_id?>][<?php echo $row->item_id?>]" readonly><?php echo $value?></textarea>
							</td><?php
						}
					}
					break;
				...
				case 5:
					...
					if( $size > 0 )
					{
						echo '<td><select name="appraisal_field['.$col->section_column_id.']['.$child->item_id.']" class="rating-field" disabled="disabled">';
					}
					else{
						echo '<td><select name="appraisal_field['.$col->section_column_id.']['.$row->item_id.']" class="rating-field" disabled="disabled">';	
					}
				...
				case 6:
					if( $size > 0 )
					{
						...
						echo '<td><input type="text" class="form-control weighted_rating-field" name="field['.$col->section_column_id.']['.$child->item_id.']" value="'.$value.'" readonly></td>';
					}
					else{
						$where = array(
							'appraisal_id' => $appraisal_id,
						...
						echo '<td><input type="text" class="form-control weighted_rating-field" name="field['.$col->section_column_id.']['.$row->item_id.']" value="'.$value.'" readonly></td>';
					}
					break;
				case 7: //weight
					if( $size > 0 )
