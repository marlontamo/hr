					...
					<div class="col-md-12">
						<div class="tabbable tabbable-custom tabbable-full-width">
							...
							<div class="tab-content">
								<div id="profile_tab_1" class="tab-pane">
									<div class="portlet">
								...
								<div id="profile_tab_2" class="tab-pane active">
											...
											@if( $appraisee->to_user_id == $user['user_id'] && $appraisee->period_status )
							                	@if( $appraisee->status_id == 10 )
							                		<div class="col-md-offset-4 col-md-8">
														...
														<!-- <button type="button" class="btn blue btn-sm" onclick="cs_discussion_form(<?php echo $appraisee->appraisal_id?>, '', <?php echo $appraisee->user_id?>, '', true)">Discussion Log</button> -->
														<button type="button" class="btn green btn-sm" onclick="change_status( $(this).closest('form'), 5)"><i class="fa fa-check"></i> Send To Immediate</button>
