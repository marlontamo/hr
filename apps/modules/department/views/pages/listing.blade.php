	...
	<ul class="page-breadcrumb breadcrumb">
		@section('page-breadcrumb-back')
			<li class="pull-right btn-group" style="position:relative;">
				...
				<span>{{ lang('department.back') }}</span>
				</button></a>
			</li>
		@show
		<li class="btn-group">
			...
			<ul role="menu" class="dropdown-menu pull-right">
				<li><a href="{{ $mod->url }}"><i class="fa fa-refresh"></i> {{ lang('department.refresh') }}</a></li>
				
				<li class="hidden import-button"><a href="javascript:void(0)" onclick="mod_import({{ $mod->mod_id }})"><i class="fa fa-cloud-download"></i> {{ lang('department.import') }}</a></li>
				<li class="divider hidden"></li>
				<li class="hidden"><a href="#"><i class="fa fa-cloud-upload"></i> {{ lang('department.export') }}</a></li>
			</ul>
		</li>
		<li>
			<i class="fa fa-home"></i>
			<a href="{{ base_url('') }}">{{ lang('department.home') }}</a> 
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			<a href="{{ get_mod_route('user_manager') }}">{{ lang('department.user_manager') }}</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
