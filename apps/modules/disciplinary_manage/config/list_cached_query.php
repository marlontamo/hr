...
, offsanction.sanction as da_sanction, da.created_on as da_created_on, da.modified_on as da_modified_on
FROM (`ww_partners_incident`)
INNER JOIN ww_partners_disciplinary_action da ON ww_partners_incident.incident_id = da.incident_id 
