		...
		<div class="portlet">
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						@if ($disciplinary_report)
						<li class=""><a href="{{ get_mod_route('disciplinary') }}">{{ lang('common.personal') }}</a></li>
						@endif
						@if ($disciplinary_manage)
						<li class="active"><a href="{{ get_mod_route('disciplinary_manage') }}">{{ lang('common.manage') }}</a></li>
						@endif
						@if ($disciplinary_admin)
						<li class=""><a href="{{ get_mod_route('disciplinary_admin') }}">{{ lang('common.admin') }}</a></li>
						@endif
					</ul>
				</div>
			</div>
			...
			<div class="portlet-title">
				<div class="caption">
					...
					{{ lang('disciplinary_manage.da_list') }}
				</div>
