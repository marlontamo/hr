        ...
        <div class="form-horizontal" >
			<div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                   		<div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
                            <input type="text" class="form-control" name="partners_personal[probationary_date]" id="partners_personal-probationary_date" value="{{ $record_personal[1]['partners_personal.probationary_date'] }}" placeholder="{{ lang('common.enter') }} {{ $partners_labels['probationary_date'] }}" >
                            <span class="input-group-btn">
                            <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                            </span>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                   		<div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
                            <input type="text" class="form-control" name="partners_personal[original_date_hired]" id="partners_personal-original_date_hired" value="{{ $record_personal[1]['partners_personal.original_date_hired'] }}" placeholder="{{ lang('common.enter') }} {{ lang('partners.ohire_date') }}" >
                            <span class="input-group-btn">
                            <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                            </span>
                        </div>
