                    ...
                    <div class="form-horizontal">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea rows="3" class="form-control"name="partners_personal_history[training-remarks][]" id="partners_personal_history-training-remarks" ><?php echo array_key_exists('training-remarks', $training) ? $training['training-remarks'] : ""; ?></textarea>
                                </div>
                            </div>                             
                        </div>
                    </div>
