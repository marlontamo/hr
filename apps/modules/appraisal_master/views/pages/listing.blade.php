	...
	<div class="col-md-9">
		<div class="portlet">
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						@if ($permission_appraisal_master)
						<li class="active"><a href="{{ get_mod_route('appraisal_master') }}">Category</a></li>
						@endif
						@if ($permission_competency_values)
						<li class=""><a href="{{ get_mod_route('competency_values') }}">Value</a></li>
						@endif
						@if ($permission_competency_libraries)
						<li class=""><a href="{{ get_mod_route('competency_libraries') }}">Library</a></li>
						@endif
						@if ($permission_competency_level)
						<li class=""><a href="{{ get_mod_route('competency_level') }}">Level</a></li>
						@endif
					</ul>
				</div>
			</div>
			...
			<div class="portlet-title">
				<div class="caption"><i class="fa {{ $mod->icon}}"></i>List of Categories</div>
