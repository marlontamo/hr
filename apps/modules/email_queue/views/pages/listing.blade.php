				...
				<div class="portlet-body">
					<div >
						<ul class="nav nav-tabs ">
							@if ($email)
							<li class="active"><a href="{{ get_mod_route('email_queue') }}">Emails</a></li>
							@endif
							@if ($sms)
							<li class=""><a href="{{ get_mod_route('sms_queue') }}">SMS</a></li>
							@endif
						</ul>
					</div>
				</div>
				...
				<div class="portlet-title">
					...
					<div class="actions ">
						...
						@if( isset( $permission['delete']) && $permission['delete'] )
							<a href="javascript:delete_records()" class="btn btn-sm btn-danger hidden"><i class="fa fa-trash-o"></i></a>
						@endif
					</div>
				</div>
				<div class="clearfix">
