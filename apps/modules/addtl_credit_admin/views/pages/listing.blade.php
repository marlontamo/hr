				...
				<div class="portlet-body">
					<div >
						<ul class="nav nav-tabs ">
							@if ($addtl_credit)
								<li class="active"><a href="{{ get_mod_route('addtl_credit_admin', 'index/'.$user_id) }}">Credit</a></li>
							@endif
							@if ($addtl_usage)
								<li class=""><a href="{{ get_mod_route('addtl_usage_admin', 'index/'.$user_id) }}">Usage</a></li>
							@endif
						</ul>
					</div>
				</div>
