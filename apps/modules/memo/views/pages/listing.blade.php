		...
		<div class="col-md-9">
			<div class="portlet">
				<div class="portlet-body">
					<div >
						<ul class="nav nav-tabs ">
							@if ($memo_manage)
							<li class=""><a href="{{ get_mod_route('memo_manage') }}">{{ lang('common.manage') }}</a></li>
							@endif
							@if ($memo)
							<li class="active"><a href="{{ get_mod_route('memo') }}">{{ lang('common.admin') }}</a></li>
							@endif
						</ul>
					</div>
				</div>
				...
				<div class="portlet-title">
					<div class="caption"><i class="fa {{ $mod->icon}}"></i>{{ lang('memo.list') }}</div>
