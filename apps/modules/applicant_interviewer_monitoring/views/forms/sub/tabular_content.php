...
?>
            <tbody class="multiple_add">
                ...
                <tr class="multiple-itemrow">
                    <td width="50%" class="active multiple_item" style="font-size:13px !important;">                
                        <span class="pull-right small text-muted delete-item" >
                           <a class="pull-right small text-muted"  href="#" <?php if($is_disabled == 0) echo "onclick='delete_item($(this).closest('tr'))'" ?> >Delete</a>
                        </span>

                        <input id="maxlength_defaultconfig" <?php if($is_disabled == 1) echo "disabled='true'" ?> class="form-control" type="text" 
                        ...
                        <span class="add-item" <?php echo $astyle ?>>
                            <button href="#" data-toggle="modal" <?php if($is_disabled == 1) echo "disabled='true'" ?> class="btn btn-success btn-xs" type="button" onclick="add_item('<?php echo $data['header_text'] ?>', '<?php echo $key['key_code']?>')" >Add <?php echo $data['header_text'] ?></button>
                        </span>
                    </td>
                    <td width="50%">
                        <textarea class="form-control" rows="3" <?php if($is_disabled == 1) echo "disabled='true'" ?> name="recruitment_interview_details[<?php echo $key['key_code']?>][key_value][]"><?php echo $value['key_value'] ?></textarea>
                    </td>
                ...
                <tr>
                    ...
                    <td width="50%"><textarea class="form-control" <?php if($is_disabled == 1) echo "disabled='true'" ?> rows="3" name="recruitment_interview_details[<?php echo $key['key_code']?>][key_value][]"></textarea>
                    </td>
