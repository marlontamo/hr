    ...
    <div class="modal-body padding-bottom-0">
        <div class="">
            <ul class="nav nav-tabs ">
                ...
                <li class="active"><a href="#tab_preemp" data-toggle="tab"><?=lang('applicant_monitoring.preemp')?></a></li>
            </ul>
            <div class="tab-content margin-top-20" style="min-height:300px;">
                ...
                <div class="tab-pane active" id="tab_preemp">
                    <div class="portlet">
                        <div class="portlet-body" >
                            ...
                            <table class="table table-condensed table-striped table-hover" >
                                <thead>
                                    <tr>                                        
                                        <th width="47%" class="padding-top-bottom-10" >Requirements</th>
                                        <th width="32%" class="padding-top-bottom-10 ">Completed</th>
                                        <th width="26%" class="padding-top-bottom-10" >Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php 
                                    ...
                                    <tr rel="0">
                                        ...
                                        <td>
                                            ...
                                            <?php }else{ ?>
                                                <span ><i class="fa fa-check text-success"></i> Done</span>
                                            <?php } ?>
                    ...
                    <div class="modal-footer margin-top-0 pull-right">
                        <button class="btn btn-default btn-sm" data-dismiss="modal" type="button">Close</button>
                        <button class="demo-loading-btn btn btn-success btn-sm" onclick="move_to_c201(<?php echo $process->process_id?>)" type="button">Proceed to Create 201</button>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('.submitted-temp').change(function(){
            var submitted = 0;
            if( $(this).is(':checked') ){
                $('#recruitment_process_employment_checklist-submitted').val('1');
                submitted = 1;
            }
            else{
                $('#recruitment_process_employment_checklist-submitted').val('0');
            }
