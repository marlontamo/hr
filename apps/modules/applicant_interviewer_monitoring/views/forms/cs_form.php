                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <?php
                                                ...
                                                echo form_dropdown('signing[template_id]',$options, $template_id, 'class="form-control select2me" data-placeholder="Select..."');
                                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <div class="make-switch" data-off="danger" data-on="success" data-on-label="&nbsp;Accept&nbsp;&nbsp;" data-off-label="&nbsp;Decline&nbsp;">
                                            <input type="checkbox" value="0" <?php if( $signing_accepted ) echo 'checked="checked"'?> name="cs_status[temp]" id="signing-accepted-temp" class="dontserializeme toggle"/>
