		...
		<!-- START FORM -->
               <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        value="<?php echo array_key_exists('affiliation-name', $affiliation) ? $affiliation['affiliation-name'] : ""; ?>" placeholder="Enter Name"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        value="<?php echo array_key_exists('affiliation-position', $affiliation) ? $affiliation['affiliation-position'] : ""; ?>" placeholder="Enter Position"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        {{ form_dropdown('partners_personal_history[affiliation-month-end][]',$months_options, $affiliation_month_end, 'class="form-control select2me" data-placeholder="Select..."') }}
                            ...
                            value="<?php echo array_key_exists('affiliation-year-end', $affiliation) ? $affiliation['affiliation-year-end'] : ""; ?>"placeholder="Year">
                            </span>                            
                        </div>
                </div>
