    	...
    	<div class="portlet-body form">
    		...
    		<!-- START FORM -->	
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <textarea rows="3" class="form-control"name="partners_personal_history[employment-duties][]" id="partners_personal_history-employment-duties" ><?php echo array_key_exists('employment-duties', $employment) ? $employment['employment-duties'] : ""; ?></textarea>
                        </div>
                    </div>
