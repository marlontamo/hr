			...
			<div class="form-body">
                ...
                <?php
                    ...
                    ?>
                        <div class="form-group hidden-sm hidden-xs" id="phone-count-<?php echo $count_phone; ?>">
                            <label class="control-label col-md-3">{{ lang('partners_immediate.phone') }} 
                ...
                ?>
                        <div class="form-group hidden-sm hidden-xs" id="mobile-count-<?php echo $count_mobile; ?>">
                            <label class="control-label col-md-3">{{ lang('partners_immediate.mobile') }} 
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ lang('partners_immediate.email') }} {{ lang('partners_immediate.address') }}</label>
                    <div class="col-md-5">
