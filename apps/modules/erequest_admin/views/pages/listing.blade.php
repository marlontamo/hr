			...
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						@if ($erequest)
						<li class=""><a href="{{ get_mod_route('erequest') }}">{{ lang('common.personal') }}</a></li>
						@endif
						@if ($erequest_admin)
						<li class="active"><a href="{{ get_mod_route('erequest_admin') }}">{{ lang('common.admin') }}</a></li>
						@endif
					</ul>
				</div>
			</div>
