<form id="discussion-form">
	<div class="panel panel-info">
		...
		<div class="panel-heading">
			<h4 class="panel-title">{{ lang('erequest_admin.discussion_log') }}</h4>
		</div>
		<div class="panel-body">
			...
			<div class="chat-form margin-bottom-20 margin-top-0 @if($record['view']=='detail') hidden @endif">
				<div class="input-cont">   
					<input type="text" placeholder="{{ lang('erequest_admin.write_comments') }}..." class="form-control" name="discussion_notes" id="discussion_notes">
				</div>
				<div class="btn-cont"> 
