				...
				case 4:
					...
					{ ?>
						<td rowspan="<?php echo ($size > 0 ? $size : 1) ?>">
							<span class="pull-right small text-muted"><a class="pull-right small text-muted" href="javascript:delete_item(<?php echo $row->item_id?>)">Delete</a></span>
						...
						if( $size > 0 )
						{
							...
							<td>
								<span class="pull-right small text-muted"><a class="pull-right small text-muted" href="javascript:delete_item(<?php echo $child->item_id?>)">Delete</a></span>
								<textarea class="form-control" rows="1" name="item[<?php echo $child->item_id?>]"><?php echo $child->item?></textarea>
								<?php if( $size == 1 ){ ?>
								<br/>
								<span>
                                	<button class="btn btn-success btn-xs" type="button" onclick="add_item(<?php echo $col->section_column_id?>,  '', <?php echo $row->item_id?>)" >Add Item</button>
                                </span><?php
								} ?>
