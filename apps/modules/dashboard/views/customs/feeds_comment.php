...
<?php
    ...
    $comment_count++;
?>
<li class="comment-list-item-<?php echo $feeds_comment_id; ?> comment-toggle-<?php echo $comment_count; ?>" style="padding:none !important;">
    ...
    <div class="message"> 
        ...
        <span class="<?php echo $feeds_userid === $user_id ? 'datetime pull-right' : 'datetime pull-right'; ?>">
            <div class="btn-group <?php echo $feeds_userid === $user_id ? 'datetime pull-right' : 'datetime pull-right'; ?>">
                <a data-toggle="dropdown" data-close-others="true" href="#" class="btn btn-xs text-muted"><i class="fa fa-gear"></i></a>
                <ul class="dropdown-menu <?php echo $feeds_userid === $user_id ? 'pull-left' : 'pull-right'; ?>">
                    <li><a class="pull-left edit-comment" 
                        data-comment-commentid="<?php echo $feeds_comment_id; ?>"
                        data-comment-feedsid="<?php echo $id; ?>"
                        data-comment-userid="<?php echo $user_id; ?>"
                        data-comment-comment="<?php echo $comment; ?>"
                        data-comment-fuserid="<?php echo $feeds_userid; ?>">
                        <i class="fa fa-pencil"></i> <?php echo lang('dashboard.comment_edit') ?></a></li>
                    <li><a href="javascript: delete_comment(<?php echo $feeds_comment_id; ?>)" class="pull-left"><i class="fa fa-trash-o"></i> <?php echo lang('dashboard.comment_delete') ?></a></li>            
                </ul>
            </div>
            <small id="feed-time-<?php echo $feeds_comment_id; ?>" class="text-muted"><?php echo date('F d \a\t g:iA', strtotime($createdon)); ?></small>
        </span>
<br>
    <span>
        <?php echo $comment; ?>
