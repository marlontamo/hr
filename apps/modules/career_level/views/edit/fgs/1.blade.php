<div class="portlet">
	<div class="portlet-title">
		...
		<div class="portlet-body form">			<div class="form-group">
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('career_level.job_rank_level') }}</label><span class="required">* </span>
				...
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('career_level.career_level_code') }}</label><span class="required">* </span>
