    ...
    <form method="post" fg_id="1" class="form-horizontal">
        ...
        <div class="portlet-body form">         
            <div class="form-group">
                ...
                <div class="col-md-7">                          
                    <input type="text" disabled="disabled" class="form-control" name="users_job_rank_level[job_rank_level]" id="users_job_rank_level-job_rank_level" value="{{ $record['users_job_rank_level.job_rank_level'] }}" placeholder="{{ lang('career_level.p_job_rank_level') }}" />              
                </div>  
            </div>          
            <div class="form-group">
