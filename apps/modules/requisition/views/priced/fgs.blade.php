					...
					<table class="table table-condensed table-striped table-hover" >
						...
						<tbody class="item-list">
							@foreach( $items as $item )
								<tr>
									<td>
										<input type="hidden" name="requisition_items[unit_price][]" value="{{ $item->unit_price }}" readonly/>
									...
									<td>
										<div class="make-switch switch-small switch-success" data-on-label="<i class='fa fa-check icon-white'></i>" data-off-label="<i class='fa fa-times'></i>">
									    	<input type="checkbox" value="1" @if( $item->proceed ) checked="checked" @endif name="temprequisition_items[proceed][]" class="dontserializeme toggle" readonly/>
