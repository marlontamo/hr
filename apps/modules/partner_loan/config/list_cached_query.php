...
$config["list_cached_query"] = 'SELECT `ww_payroll_partners_loan`.`partner_loan_id` as record_id, ww_payroll_partners_loan.user_id as "payroll_partners_loan_user_id", T2.loan as "payroll_partners_loan_loan_id", T3.loan_status as "payroll_partners_loan_loan_status_id", DATE_FORMAT(ww_payroll_partners_loan.entry_date, \'%M %d, %Y\') as "payroll_partners_loan_entry_date", ww_payroll_partners_loan.no_payments as "payroll_partners_loan_no_payments", T6.account_name as "payroll_partners_loan_releasing_debit_account_id", T7.account_name as "payroll_partners_loan_releasing_credit_account_id", ww_payroll_partners_loan.week as "payroll_partners_loan_week", ww_payroll_partners_loan.loan_principal as "payroll_partners_loan_loan_principal", ww_payroll_partners_loan.amount as "payroll_partners_loan_amount", ww_payroll_partners_loan.interest as "payroll_partners_loan_interest", ww_payroll_partners_loan.beginning_balance as "payroll_partners_loan_beginning_balance", ww_payroll_partners_loan.description as "payroll_partners_loan_description", DATE_FORMAT(ww_payroll_partners_loan.start_date, \'%M %d, %Y\') as "payroll_partners_loan_start_date", T14.payment_mode as "payroll_partners_loan_payment_mode_id", ww_payroll_partners_loan.no_payments_remaining as "payroll_partners_loan_no_payments_remaining", T16.account_name as "payroll_partners_loan_amortization_credit_account_id", T17.account_name as "payroll_partners_loan_interest_credit_account_id", ww_payroll_partners_loan.running_balance as "payroll_partners_loan_running_balance", ww_payroll_partners_loan.system_amortization as "payroll_partners_loan_system_amortization", ww_payroll_partners_loan.system_interest as "payroll_partners_loan_system_interest", ww_payroll_partners_loan.user_amortization as "payroll_partners_loan_user_amortization", ww_payroll_partners_loan.user_interest as "payroll_partners_loan_user_interest", DATE_FORMAT(ww_payroll_partners_loan.last_payment_date, \'%M %d, %Y\') as "payroll_partners_loan_last_payment_date", ww_payroll_partners_loan.total_amount_paid as "payroll_partners_loan_total_amount_paid", ww_payroll_partners_loan.no_payments_paid as "payroll_partners_loan_no_payments_paid", ww_payroll_partners_loan.total_arrears as "payroll_partners_loan_total_arrears", `ww_payroll_partners_loan`.`created_on` as "payroll_partners_loan_created_on", `ww_payroll_partners_loan`.`created_by` as "payroll_partners_loan_created_by", `ww_payroll_partners_loan`.`modified_on` as "payroll_partners_loan_modified_on", `ww_payroll_partners_loan`.`modified_by` as "payroll_partners_loan_modified_by"
...
WHERE (
	...
	ww_payroll_partners_loan.total_arrears like "%{$search}%" 	
)';