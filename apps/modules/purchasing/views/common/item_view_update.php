<table class="table table-condensed table-striped table-hover" >
	<thead>
		<tr>
			<th width="15%" class="padding-top-bottom-10" >Item</th>
			<th width="15%" class="padding-top-bottom-10" >Reason</th>
			<th width="12%" class="padding-top-bottom-10" >Date</th>
			<th width="13%" class="padding-top-bottom-10" >Quantity</th>
			<th width="13%" class="padding-top-bottom-10" >Unit</th>
			<th width="13%" class="padding-top-bottom-10" >Amount</th>
			<th width="8%" class="padding-top-bottom-10" >Status</th>
		</tr>
	</thead>
	<tbody class="item-list">
		@foreach( $items as $item )
			...
			<tr class="warning">
				<td class="text-right">Actual Price:</td>
				<td>
                    <input type="text" name="requisition_items[actual_price][]" data-inputmask="'alias': 'decimal', 'autoGroup': true, 'groupSeparator': ',', 'groupSize': 3, 'repeat': 13, 'greedy' : false" class="form-control" value="{{ $item->actual_price }}" readonly>
                </td>
                <td class="text-right">Actual Amount:</td>
                <td>
                    <input type="text" name="requisition_items[actual_amount][]" value="{{ $item->actual_amount }}" data-inputmask="'alias': 'decimal', 'autoGroup': true, 'groupSeparator': ',', 'groupSize': 3, 'repeat': 13, 'greedy' : false" class="form-control" readonly>
                </td>
                <td></td>
			</tr>
		@endforeach
