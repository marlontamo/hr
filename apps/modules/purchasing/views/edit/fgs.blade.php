						...
						<tbody class="item-list">
							@foreach( $items as $item )
								...
								<tr class="warning">
									...
									<td>
                                        <input type="text" name="requisition_items[actual_price][]" data-inputmask="'alias': 'decimal', 'autoGroup': true, 'groupSeparator': ',', 'groupSize': 3, 'repeat': 13, 'greedy' : false" class="form-control" value="{{ $item->actual_price }}">
                                    </td>
