  ...
  <div class="row" align="center">
    <div class="col-md-12">
      <div class="">
        ...
        @if( $record['requisition.status_id'] == 10 )
          <button type="button" class="btn yellow btn-sm" onclick="save_record( $(this).closest('form'), 12)"><i class="fa fa-check"></i>  For Validation</button>
        @endif
