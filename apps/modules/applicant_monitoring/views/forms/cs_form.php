    ...
    <div class="modal-body padding-bottom-0">
        <div class="">
            <ul class="nav nav-tabs ">
                ...
                <li class="active"><a data-toggle="tab" href="#tab_cs"><?=lang('applicant_monitoring.cs')?></a></li>
            </ul>
            <div class="tab-content margin-top-20" style="min-height:300px;">
                ...
                <div id="tab_cs" class="tab-pane active">
                    <div class="portlet">
                        <div class="portlet-title">
                        ...
                        <div class="portlet-body form margin-top-25">
                            ...
                            <form class="form-horizontal margin-top-25" name="cs-form" method="post">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4">Template<span class="required">*</span>
                                    </label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <?php
                    ...
                    <div class="modal-footer margin-top-0">
                        <?php 
                            $hidden_201 = '';
                            $show_hidden = (isset($template_id) && !empty($template_id)) ? '' : 'hidden'; 
                            if (!$signing_already &&  $signing_accepted != 1) {
                                $hidden_201 = "style='display:none'";
                            }
                        ?>
                        <button class="btn btn-default btn-sm" data-dismiss="modal" type="button">Close</button>
                        <button <?=$hidden?> type="button" onclick="save_cs()" class="demo-loading-btn btn btn-success btn-sm">Save</button>
                        <button id="print_cs" type="button" class="btn btn-sm btn-info <?php echo $show_hidden;?>"><i class="fa fa-print"></i> Print</button>
                        <button id="create_201" class="demo-loading-btn btn btn-success btn-sm" <?php $hidden_201 ?> onclick="move_to_c201(<?php echo $process->process_id?>)" type="button"><?=lang('applicant_monitoring.proceed_to_201')?></button>                        
                    </div>
                </div>
            </div>                        
        </div>
