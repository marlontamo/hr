...
@section('page-breadcrumb')
	<ul class="page-breadcrumb breadcrumb">
		...
		<li>
			<a href="{{ site_url('payroll/setup') }}">{{ lang('leave_conversion_period.payroll_setup') }}</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
...
@section('page_plugins')
	...
	<script type="text/javascript" src="{{ theme_path() }}modules/leave_conversion_period/lists_custom.js"></script>
@stop
