				...
				<div class="portlet-body">
					<div >
						<ul class="nav nav-tabs ">
							@if ($movement)
							<li class=""><a href="{{ get_mod_route('movement') }}">{{ lang('common.personal') }}</a></li>
							@endif
							@if ($movement_manage)
							<li class=""><a href="{{ get_mod_route('movement_manage') }}">{{ lang('common.manage') }}</a></li>
							@endif
							@if ($movement_admin)
							<li class="active"><a href="{{ get_mod_route('movement_admin') }}">{{ lang('common.admin') }}</a></li>
							@endif
						</ul>
					</div>
				</div>
...
@section('page_plugins')
	@parent
	<script type="text/javascript" src="{{ theme_path() }}modules/movement/lists.js"></script>
