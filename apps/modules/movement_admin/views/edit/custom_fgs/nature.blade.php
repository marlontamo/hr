								...
								<div class="form-group">
									...
									<div class="col-md-7">
										...
										<div class="input-group">
											...
											<?php echo form_dropdown('partners_movement_action[remarks_print_report_id]',$partners_movement_remarks_print_report_id_options, $record['partners_movement_action.remarks_print_report_id'], 'class="form-control select2me" data-placeholder="Select..." id="remarks_print_report_id"') ?>
										</div> 				
									</div>	
								</div>											
<!-- 								<div class="form-group">
									<?php if ($disable != '') { ?>
										<input type="hidden" name="partners_movement_action[remarks]" value="<?php echo $record['partners_movement_action.remarks'] ?>" />
									<?php } ?>									
    ...
    $(document).ready(function(){
		...
		$('.partner_id').change(function(){
			...
			if(type==1 || type==3 || type==8 || type==9 || type==12){
				...
				get_employee_allowance_details($(this).val(), $(this).data('count'));
			}
		});
