			...
			<div class="form-group">
				...
				<?php	}else{
					...
					<div class="input-group">
						...
						?>
							<option <?php echo $selected; ?>  value="<?php echo $transfer_field['table_name'] == 'ww_users' ? $option->user_id : $transfer_field['table_name'] == 'ww_users_job_grade_level' ? 'job_grade_id' : $option->$option_field_id; ?>">
