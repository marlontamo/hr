...
@section('page-breadcrumb')
	<ul class="page-breadcrumb breadcrumb">
		...
		<li>
			<a href="{{ get_mod_route('performance_master') }}">{{ lang('performance_notification.performance_master') }}</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			...
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						...
						<li class=""><a href="{{ get_mod_route('rating_group') }}">Rating Scale</a></li>
						@endif
