...
<!--                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea rows="3" class="form-control" name="recruitment_personal_history[skill-remarks][]" id="recruitment_personal_history-skill-remarks" ><?php echo array_key_exists('skill-remarks', $skill) ? $skill['skill-remarks'] : ""; ?></textarea>
                    </div>
                </div>
