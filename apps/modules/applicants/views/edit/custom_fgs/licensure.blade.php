	...
	<div class="portlet-body form">
		...
		<!-- START FORM -->	                
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea rows="3" class="form-control"name="recruitment_personal_history[licensure-remarks][]" id="recruitment_personal_history-licensure-remarks" ><?php echo array_key_exists('licensure-remarks', $licensure) ? $licensure['licensure-remarks'] : ""; ?></textarea>
                    </div>
                </div>
                <!-- <div class="form-group">
