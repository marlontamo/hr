<div class="portlet">
	<div class="portlet-title">
		<div class="caption">{{ lang('applicants.work_assignment') }}</div>
		<div class="tools">
        ...
        <div class="form-horizontal" >
			<div class="form-body">	                        	
            	<div class="form-group">
                    <label class="control-label col-md-3">{{ lang('applicants.reports_to') }}</label>
                    <div class="col-md-5">
              ...
              <!--   <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                       <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="recruitment_personal[organization]" id="recruitment_personal-organization" value="{{ $record_personal[1]['recruitment_personal.organization'] }}" placeholder="Enter Organization"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">{{ lang('applicants.division') }}</label>
                    <div class="col-md-5">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ lang('applicants.dept') }}</label>
                    <div class="col-md-5">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ lang('applicants.group') }}</label>
                    <div class="col-md-5">
