                        ...
                        <div class="form-horizontal">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" maxlength="25" name="recruitment_personal_history[attachment-name]" id="recruitment_personal_history-attachment-name" value ="<?php echo array_key_exists('attachment-name', $details) ? $details['attachment-name'] : ""; ?>" placeholder="Enter File Name">
                                    </div>
                                </div>
                                <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">                          
                                        <div data-provides="fileupload" class="fileupload fileupload-new" id="recruitment_personal_history-file-container">
                                            <input type="hidden" name="recruitment_personal_history[attachment-file]" id="recruitment_personal_history-file" value="<?php echo array_key_exists('attachment-file', $details) ? $details['attachment-file'] : ""; ?>"/>
