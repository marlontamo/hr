		...
		<div class="col-md-9">
			<div class="portlet">
				<div class="portlet-title">
					<div class="caption"><i class="fa {{ $mod->icon}}"></i>{{ lang('applicants.app_list') }}</div>
			...
			<div class="portlet">
				...
				<div class="portlet-body">
					...
					<div class="margin-top-10">
						...
						<span href="javascript:void(0)" class="filter-status event-block label label-default" filter_value="{{ $status['recruit_status_id'] }}"> {{ $status['recruit_status'] }}</span>
						@endforeach
					</div>
				</div>
				...
				<div class="portlet-body">
					<span class="small text-muted list-filter">Filter applicant entry point.</span>
					<div class="margin-top-10">
						<span class="filter-source event-block label label-success" filter_value="">All</span>
						@foreach ($recruit_source as $source)
						<span href="javascript:void(0)" class="filter-source event-block label label-default" filter_value="{{ $source['source_id'] }}"> {{ $source['source'] }}</span>
						@endforeach
					</div>
				</div>
				...
				<div class="portlet-body">
					<span class="small text-muted">Filter active/inactive post.</span>
					<div class="margin-top-10">
						<span class="filter-post event-block label label-success" filter_value="active">Active</span>
						<span class="filter-post event-block label label-default" filter_value="inactive">Inactive</span>
						<span class="filter-post event-block label label-default" filter_value="">All</span>
					</div>
				</div>
			</div>
