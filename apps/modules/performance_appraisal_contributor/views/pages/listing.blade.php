   	...
   	<div class="portlet-body">
		<div class="tabbable-custom ">
			<ul class="nav nav-tabs ">
				@if($allow_personal)
				<li><a href="{{ get_mod_route('appraisal_individual_rate') }}">Personal</a></li>
				@endif
				@if($allow_manage)
				<li><a href="{{ get_mod_route('performance_appraisal_manage') }}">Manage</a></li>
				@endif
				<li class="active"><a href="{{ get_mod_route('performance_appraisal_contributor') }}">Crowdsourced Feedback Requests</a></li>
			</ul>
		</div>
	</div>
	<br>
		...
		<div class="col-md-9">
			<div class="portlet">
				<div class="portlet-title">
					<div class="caption"><i class="fa {{ $mod->icon}}"></i>List of Crowdsourced Feedback Requests</div>
