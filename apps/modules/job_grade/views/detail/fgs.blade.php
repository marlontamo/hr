<div class="portlet">
	<div class="portlet-title">
		...
		<div class="portlet-body form">			<div class="form-group">
				...
				<div class="col-md-7">							<input type="text" disabled="disabled" class="form-control" name="users_job_grade_level[job_level]" id="users_job_grade_level-job_level" value="{{ $record['users_job_grade_level.job_level'] }}" placeholder="{{ lang('job_grade.p_job_grade') }}" /> 				</div>	
			</div>			<div class="form-group">
				<label class="control-label col-md-3">{{ lang('job_grade.job_grade_code') }}</label>
				<div class="col-md-7">							<input type="text" disabled="disabled" class="form-control" name="users_job_grade_level[job_grade_code]" id="users_job_grade_level-job_grade_code" value="{{ $record['users_job_grade_level.job_grade_code'] }}" placeholder="{{ lang('job_grade.p_job_grade_code') }}" /> 				</div>	
			</div>			<div class="form-group">
