...
<li class="comment-list-item-<?php echo $feeds_comment_id; ?> comment-toggle-<?php echo $comment_count; ?>" style="padding:none !important;">
    ...
    <div class="message"> 
        ...
        <span class="<?php echo $feeds_userid === $user_id ? 'datetime pull-left' : 'datetime pull-right'; ?>">
            <div class="btn-group <?php echo $feeds_userid === $user_id ? 'datetime pull-left' : 'datetime pull-right'; ?>">
