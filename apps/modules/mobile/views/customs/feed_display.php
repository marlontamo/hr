                    ...
                    <?php
                        ...
                        ?>
                            <ul id="comment-list-<?php echo $feed->id; ?>">
                                ...
                                <span class="<?php echo $current_user === $feed->user_id ? 'datetime pull-left' : 'datetime pull-right'; ?>">
                                    <?php 
                                        if ($current_user == $comment['user_id']){
                                    ?>
                                    <div class="btn-group <?php echo $current_user === $feed->user_id ? 'datetime pull-left' : 'datetime pull-right'; ?>">
                                    ...
                                    ?>
                                    <div class="btn-group <?php echo $current_user === $feed->user_id ? 'datetime pull-left' : 'datetime pull-right'; ?>">
                                        <a href="javascript: delete_comment(<?php echo $comment['feeds_comment_id']; ?>)" class="btn btn-xs text-muted pull-left"><i class="close"></i></a>
                                    </div>
                                    <?php 
                                        }
                                    ?>
