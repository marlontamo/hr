	...
	<ul class="page-breadcrumb breadcrumb">
		...
		<li class="btn-group">
			...
			<ul role="menu" class="dropdown-menu pull-right">
				<li><a href="{{ $mod->url }}"><i class="fa fa-refresh"></i> {{ lang('position.refresh') }}</a></li>
				...
				<li class="hidden"><a href="#"><i class="fa fa-cloud-upload"></i> {{ lang('position.export') }}</a></li>
			</ul>
		</li>
		<li>
			<i class="fa fa-home"></i>
			<a href="{{ base_url('') }}">{{ lang('position.home') }}</a> 
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			<a href="{{ get_mod_route('user_manager') }}">{{ lang('position.user_manager') }}</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
