...
<!-- <td class="hidden-xs">
    ...
    <td>
        <a id="users_position_position" href="<?php echo $detail_url; ?>"><?php echo $users_position_position; ?></a>
        <br>
        <span id="users_position_position_code" class="small"><?php echo $users_position_position_code; ?></span>
    </td>
    <td class="hidden-xs">
        <span id="users_position_immediate_id;"><?php echo $users_position_immediate_id; ?></span>
        <br>
        <span class="small" id="users_position_immediate_position"><?php echo $users_position_immediate_position; ?></span>
    </td>
    <td class="hidden-xs">
        <span id="users_position_status_id" <?php echo $users_position_status_id == 'Active' ? 'class="badge badge-success"' : 'class="badge badge-error"' ; ?> ><?php echo $users_position_status_id; ?></span>
    </td>
    <td>
        <div class="btn-group">
