<div class="portlet">
	...
	<div class="portlet-body form">			<div class="form-group">
				...
				<div class="col-md-7">							<div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
								<input type="text" class="form-control" name="time_forms[date_from]" id="time_forms-date_from" value="{{ $record['time_forms.date_from'] }}" placeholder="Enter Date" readonly>
