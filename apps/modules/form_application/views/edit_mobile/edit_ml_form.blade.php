					...
					<div class="portlet-body form"  id="main_form">		
						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-6">							<div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
												<input type="text" class="form-control" name="time_forms_maternity[return_date]" id="time_forms_maternity-return_date" value="{{ $record['time_forms_maternity.return_date'] }}" placeholder="Enter Report Date">
												<span class="input-group-btn">
													<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
												</span>
											</div> 				
