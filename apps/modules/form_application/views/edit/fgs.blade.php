...
</div>	                            $time_forms_scheduled_options = array('' => 'Select...');
                        		foreach($options->result() as $option)
                        		{
                        			                        				$time_forms_scheduled_options[$option-><div style="border:1px solid #990000;padding-left:20px;margin:0 0 10px 0;">
...
<p>Line Number: 74</p>
	                            ...
	                            {{ form_dropdown('time_forms[scheduled]',$time_forms_scheduled_options, $record['time_forms.scheduled'], 'class="form-control select2me" data-placeholder="Select..."') }}
	                        </div> 				</div>	
...
<p>Line Number: 74</p>
	...
	<div class="portlet-title">
		<div class="caption">Annual Leave Form</div>
		<div class="tools"><a class="collapse" href="javascript:;"></a></div>
	</div>
			<p>Annual Leave Form</p>
		<div class="portlet-body form">			<div class="form-group">
				<label class="control-label col-md-3">Status</label>
				<div class="col-md-7">							<input type="text" class="form-control" name="time_forms[form_status_id]" id="time_forms-form_status_id" value="{{ $record['time_forms.form_status_id'] }}" placeholder="Enter Status" /> 				</div>	
			</div>			<div class="form-group">
