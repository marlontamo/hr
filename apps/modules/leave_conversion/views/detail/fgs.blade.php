<div class="portlet">
	<div class="portlet-title">
		...
		<div class="portlet-body form">			<div class="form-group">
				...
				<div class="col-md-7">							<input type="text" class="form-control" name="payroll_leave_conversion[carry_over]" id="payroll_leave_conversion-carry_over" value="{{ $record['payroll_leave_conversion.carry_over'] }}" placeholder="Enter Carry Over" /> 				</div>	
			</div>			<div class="form-group">
