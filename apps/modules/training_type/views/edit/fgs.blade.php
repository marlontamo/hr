<div class="portlet">
	<div class="portlet-title">
		...
		<div class="portlet-body form">			<div class="form-group">
				...
				<div class="col-md-7">							<input type="text" class="form-control" name="training_type[training_type_code]" id="training_type-training_type_code" value="{{ $record['training_type.training_type_code'] }}" placeholder="Enter Code" /> 				</div>	
			</div>			<div class="form-group">
				<label class="control-label col-md-3"><span class="required">* </span>Type</label>
				<div class="col-md-7">							<input type="text" class="form-control" name="training_type[training_type]" id="training_type-training_type" value="{{ $record['training_type.training_type'] }}" placeholder="Enter Type" /> 				</div>	
			</div>			<div class="form-group">
