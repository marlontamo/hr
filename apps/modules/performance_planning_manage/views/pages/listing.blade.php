				...
				<div class="portlet-body">
					<div >
						<ul class="nav nav-tabs ">
							...
							@endif
							<li  class="active"><a href="{{ get_mod_route('performance_planning_manage') }}">{{ lang('common.manage') }}</a></li>
							@if ($performance_planning)
								<li><a href="{{ get_mod_route('performance_planning') }}">{{ lang('common.admin') }}</a></li>
							@endif
						</ul>
					</div>
				</div>
