	...
	<ul class="page-breadcrumb breadcrumb">
		...
		<li class="btn-group">
			...
			<ul role="menu" class="dropdown-menu pull-right">
				...
				<li class="import-button"><a href="javascript:void(0)" onclick="mod_import({{ $mod->mod_id }})"><i class="fa fa-cloud-download"></i> Import</a></li>
...
@section('page_plugins')
	...
	<script type="text/javascript" src="{{ theme_path() }}modules/import201/edit_custom.js"></script>
@stop
