                    ...
                    <div class="portlet-body form">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4"><?php echo $delivery_id['label']; ?><span class="required">*</span></label>
                                    <div class="col-md-7">
                                        <select <?= $disabled?> class="form-control selectme3" data-placeholder="Select..." id="delivery_id" name="delivery_id" >
...
<!-- 											<span class="fileupload-preview" style="margin-left:5px;"></span>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4"><?php echo $pregnancy_no['label']; ?></label>
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" maxlength="25" name="pregnancy_no" id="pregnancy_no" placeholder="2" readonly value="<?php echo $pregnancy_no['val']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4"><?php echo $expected_date['label']; ?></label>
                                    <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4"><?php echo $actual_date['label']; ?></label>
                                    <div class="col-md-7">
                                        <div class="input-group input-medium date date-picker related_dates" data-date-format="MM dd, yyyy">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4"><?php echo $return_date['label']; ?></label>
                                    <div class="col-md-7">
                                        <div class="input-group input-medium date date-picker related_dates" data-date-format="MM dd, yyyy">
