                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
	                                        <div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
	                                            ...
	                                            <input type="text" class="form-control" id="date_to" name="date_to" value="<?php echo $date_to['val']; ?>">
                                            <span class="input-group-btn">
	                                ...
	                                <div class="form-group" id="change_options_note" name="change_options_note">
	                                    ...
	                                    <div class="col-md-7">
											...
											<div class="btn-grp">
												<button id="goto_change_opt" class="btn blue btn-xs" type="button"><small>Change Options</small></button>
											</div>
	                                    </div>
	                                </div>
                                <div class="form-group">
