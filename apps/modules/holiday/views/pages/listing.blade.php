		...
		<div class="col-md-9">
			<div class="portlet">
				<div class="portlet-title">
					...
					<div class="actions">
						<a id="populate" href="javascript:void(0)" class="btn btn-sm btn-success" onclick="populate()">Populate Holiday</a>
...
@section('page_plugins')
	...
	<script type="text/javascript" src="{{ theme_path() }}modules/holiday/edit.js"></script>   
	<script type="text/javascript" src="{{ theme_path() }}modules/holiday/edit_custom.js"></script>  
