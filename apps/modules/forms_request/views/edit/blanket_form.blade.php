				...
				<div class="portlet-body form" id="main_form">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							$form_type_options[0] 	= 'Select...';
							$form_type_options[26] 	= 'Public Leave';
							$form_type_options[3] 	= 'Emergency Leave';
							$form_type_options[10] 	= 'Undertime';
							$form_type_options[15] 	= 'Excused Tardiness';
	 ...
	 <div class="row">
		<div class="col-md-12">
			<div class="col-md-offset-4 col-md-8">
				...
				<a href="<?php echo $back_url;?>" class="btn default btn-sm">Back</a>
			</div>
		</div>
	</div> 
</div>
