						...
						<div class="portlet-body">
							<div class="tabbable-custom ">
								...
								@if ($permission_app_request)
									<li class="active"><a href="{{ get_mod_route('forms_request') }}">{{ lang('form_application_admin.wrequests') }}</a></li>
								@endif
								@if ($leave_convert)
										...
										<div class="portlet margin-bottom-50 margin-top-20"> 
											...
											<div class="portlet-title">
					                            ...
					                            <div class="actions ">
					                            	...
					                            	<div class="btn-group hidden">
						                                <a href="time_application_form.php" class="btn btn-info btn-sm">
