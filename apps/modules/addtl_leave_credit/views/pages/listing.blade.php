			...
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						...
						<li class="active"><a href="{{ get_mod_route('addtl_leave_credit') }}">{{ lang('leave_balance.additional') }}</a></li>
						<li class=""><a href="{{ get_mod_route('special_leave_credit') }}">{{ lang('leave_balance.special') }}</a></li>
						<li class=""><a href="{{ get_mod_route('special_leave_credit', 'sickleave') }}">Sick Leaves</a></li>
						@endif
					</ul>
				</div>
				<input type="hidden" name="list_view" id="list_view" value="0">
			</div>
