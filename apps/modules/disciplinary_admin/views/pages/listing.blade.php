		...
		<div class="portlet">
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						...
						<li class=""><a href="{{ get_mod_route('disciplinary_manage') }}">{{ lang('common.manage') }}</a></li>
						@endif
						@if ($disciplinary_admin)
						<li class="active"><a href="{{ get_mod_route('disciplinary_admin') }}">{{ lang('common.admin') }}</a></li>
						@endif
					</ul>
				</div>
			</div>
			...
			<div class="portlet-title">
				<div class="caption">
					...
					{{ lang('disciplinary_admin.da_list') }}
				</div>
