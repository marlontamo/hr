        ...
        <div class="portlet-body form">
            <div class="form-horizontal">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 small">Venue<span class="required">*</span></label>
                        <div class="col-md-9">
                            <div class="input-icon">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 small">Start Date<span class="required">*</span></label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 small">End Date<span class="required">*</span></label>
                        <div class="col-md-9">
                            <div class="input-group input-medium pull-left">
