<div class="portlet margin-bottom-0" id="profile_header_overview">
	...
	<div class="portlet-body form">
		<input type="hidden" value="<?php echo $record['record_id']; ?>" name="record_id" id="record_id">
				<input type="hidden" value="<?php echo empty($record['record_id']) ? 1 : 0 ?>" name="is_add" id="is_add">
		<div class="row">
			<!-- IMAGE AREA -->
			<div class="col-md-2 col-sm-4">
				<ul class="list-unstyled profile-nav">
					<li>
						<img src="<?php echo base_url($record['photo']) ?>" class="img-responsive" alt="" style="width:180px;" /> 
			...
			<div class="col-md-6 col-sm-8">
				<h4 id="position-name"><?php echo $record['position_sought']; ?></h4>
				...
				<ul class="list-inline text-muted margin-bottom-10">
					<li><i class="fa fa-envelope"></i> <span id="email"> <?php echo $record['email']; ?></span></li>
				</ul>
					...
					<div class="portlet-body">
						<ul class="list-unstyled">
							...
							<li>
								...
								<span class="pull-right" id="birthday"> <?php echo $record['birth_date']; ?></span>
								<br />
							...
							<li>
								<span class="text-muted"><i class="fa fa-user"></i>&nbsp; <?php echo lang('recruitform.civil_status')?></span> 
