	...
	<div class="portlet-body form">
		...
		<!-- START FORM -->	                
                <div class="form-group">
                    <label class="control-label col-md-3 small">Title<span class="required">*</span></label>
                    <div class="col-md-9">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 small">License No.</label>
                    <div class="col-md-9">
                        <div class="input-icon">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 small">Date Taken<span class="required">*</span></label>
                    <div class="col-md-9">
                        ...
                        <span class="pull-left"><input type="text" class="form-control mask_number_year input-small" maxlength="4" name="recruitment_personal_history[licensure-year-taken][]" id="recruitment_personal_history-licensure-year-taken" placeholder="Year"></span>
                    </div>
                </div>
                <div class="form-group">
