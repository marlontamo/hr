    ...
    <form method="post" fg_id="1" class="form-horizontal">
        ...
        <div class="portlet-body form">         
            <div class="form-group">
                ...
                <div class="col-md-7">                          
                    <input type="text" disabled="disabled" class="form-control" name="users_job_pay_level[pay_level]" id="users_job_pay_level-pay_level" value="{{ $record['users_job_pay_level.pay_level'] }}" placeholder="{{ lang('pay_grade.p_pay_grade') }}" />                
                </div>  
            </div>          
            <div class="form-group">
                <label class="control-label col-md-3">{{ lang('pay_grade.pay_grade_code') }}</label>
                <div class="col-md-7">                          
                    <input type="text" disabled="disabled" class="form-control" name="users_job_pay_level[pay_level_code]" id="users_job_pay_level-pay_level_code" value="{{ $record['users_job_pay_level.pay_level_code'] }}" placeholder="{{ lang('pay_grade.p_pay_grade_code') }}" />                
                </div>  
            </div>          
            <div class="form-group">
                <label class="control-label col-md-3">{{ lang('pay_grade.active') }}</label>
                <div class="col-md-7">                          
                    <div class="make-switch" data-on-label="&nbsp;{{ lang('pay_grade.option_yes') }}&nbsp;" data-off-label="&nbsp;{{ lang('pay_grade.option_no') }}&nbsp;">
