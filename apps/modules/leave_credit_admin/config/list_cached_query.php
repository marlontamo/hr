...
$config["list_cached_query"] = 'SELECT `ww_time_form_balance`.`id` as record_id, IFNULL(ww_time_form_balance.current,0.00) as "time_form_balance_current", 
IFNULL(ww_time_form_balance.previous,0.00) as "time_form_balance_previous", T2.display_name as "time_form_balance_user_id", T3.form as "time_form_balance_form", ww_time_form_balance.year as "time_form_balance_year", 
IFNULL(ww_time_form_balance.used,0.00) as "time_form_balance_used", ww_time_form_balance.balance as "time_form_balance_balance", `ww_time_form_balance`.`created_on` as "time_form_balance_created_on", `ww_time_form_balance`.`created_by` as "time_form_balance_created_by", `ww_time_form_balance`.`modified_on` as "time_form_balance_modified_on", `ww_time_form_balance`.`modified_by` as "time_form_balance_modified_by"
...
`ww_time_form_balance`.`user_id` as user_id
