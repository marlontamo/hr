		...
		<div class="portlet">
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						...
						<li class="active"><a href="{{ get_mod_route('leave_credit_admin', 'sick_list') }}">{{ lang('leave_balance.sickl') }}</a></li>
						@endif
					</ul>
				</div>
			</div>
			<div class="portlet-title">
				<div class="caption">
					...
					<input type="hidden" name="view_list" id="view_list" value="sick">
				</div>
