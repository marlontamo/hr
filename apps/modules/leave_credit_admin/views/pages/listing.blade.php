		...
		<div class="portlet">
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						...
						<li class="active"><a href="{{ get_mod_route('leave_credit_admin') }}">{{ lang('leave_balance.annual') }}</a></li>
						<li class=""><a href="{{ get_mod_route('leave_credit_admin', 'addl_list') }}">{{ lang('leave_balance.additional') }}</a></li>
						<li class=""><a href="{{ get_mod_route('leave_credit_admin', 'special_list') }}">{{ lang('leave_balance.special') }}</a></li>
			...
			<div class="portlet-title">
				<div class="caption">
					...
					<input type="hidden" name="view_list" id="view_list" value="annual">
				</div>
