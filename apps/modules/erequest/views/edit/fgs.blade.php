<div class="portlet">
	<div class="portlet-title">
		...
		<div class="portlet-body form">			<div class="form-group">
				...
				<div class="col-md-7">							<input type="text" class="form-control" name="resources_request[request]" id="resources_request-request" value="{{ $record['resources_request.request'] }}" placeholder="{{ lang('common.enter') }} {{ lang('erequest.request_item') }}" /> 				</div>	
				...
				<div class="col-md-7">							<textarea class="form-control" name="resources_request[reason]" id="resources_request-reason" placeholder="{{ lang('common.enter') }} {{ lang('erequest.reason') }}" rows="4">{{ $record['resources_request.reason'] }}</textarea> 				</div>	
			</div>			<div class="form-group">
				...
				<div class="col-md-7">							<div data-provides="fileupload" class="fileupload fileupload-new" id="resources_request_upload-upload_id-container">
                                ...
                                <span class="fileupload-new"><i class="fa fa-paper-clip"></i> {{ lang('erequest.select_file') }}</span>
