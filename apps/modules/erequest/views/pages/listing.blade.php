...
@section('page-breadcrumb-back')
	<li class="pull-right btn-group" style="position:relative;">
		<a href="{{ get_mod_route('resources') }}"><button class="btn blue" type="button">
		...
		<div class="portlet">
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						@if ($erequest)
						<li class="active"><a href="{{ get_mod_route('erequest') }}">{{ lang('common.personal') }}</a></li>
						@endif
						@if ($erequest_admin)
						<li class=""><a href="{{ get_mod_route('erequest_admin') }}">{{ lang('common.admin') }}</a></li>
						@endif
					</ul>
				</div>
			</div>
			...
			<div class="portlet-title">
				<div class="caption">
					...
					{{ lang('erequest.my_online_request') }}
				</div>
