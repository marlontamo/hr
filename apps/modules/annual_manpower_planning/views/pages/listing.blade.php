		...
		<div class="col-md-9">
			<div class="portlet">
				<div class="portlet-body">
					<div class="tabbable-custom ">
						<ul class="nav nav-tabs ">
							@if ($amp)
							<li class="active"><a href="{{ get_mod_route('annual_manpower_planning') }}">{{ lang('common.manage') }}</a></li>
							@endif
							@if ($amp_admin)
							<li class=""><a href="{{ get_mod_route('amp_admin') }}">{{ lang('common.admin') }}</a></li>
							@endif
						</ul>
					</div>
				</div>
				...
				<div class="portlet-title">
					<div class="caption"><i class="fa {{ $mod->icon}}"></i>{{ lang('annual_manpower_planning.amp_list') }}</div>
