...
<!-- 	<li class="pull-right btn-group" style="position:relative;">
		<a href="{{ get_mod_route('training_employee_database') }}"><button class="btn blue" type="button">
		<span>Back</span>
		</button></a>
	</li> -->
@stop
		...
		<div class="col-md-9">
			<div class="portlet">
				<div class="portlet-title">
					<div class="caption"><i class="fa {{ $mod->icon}}"></i>{{ $mod->short_name }}</div>
					<div class="caption" id="head-caption">&nbsp;</div>
					<div class="actions">
						<!-- <a id="ted_export_excel" href="#" onclick="ajax_export();" class="btn btn-sm btn-success">Export</a> -->
