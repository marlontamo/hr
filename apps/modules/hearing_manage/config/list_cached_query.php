...
, ww_partners_incident_hearing.user_id as nte_id , ww_partners_incident_hearing.category as category 
, IF(ww_partners_incident_hearing.category = "partner", "Involved Employee", "Witness") AS label 
, ww_partners_incident_hearing.nte_status_id as "nte_status_id", ww_partners_incident_hearing.hearing_date as "hearing_date"
FROM (`ww_partners_incident`)
INNER JOIN ww_partners_incident_hearing ON ww_partners_incident_hearing.incident_id = ww_partners_incident.incident_id 
...
LEFT JOIN ww_partners_incident_approver appr ON ww_partners_incident.incident_id = appr.incident_id
LEFT JOIN ww_partners_incident_immediate ime ON ww_partners_incident.incident_id = ime.incident_id
WHERE (
