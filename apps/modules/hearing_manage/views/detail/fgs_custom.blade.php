...
<div class="portlet">
	...
	<div class="portlet-body">
        ...
        <div class="form-body">
        		<?php
        			$readonly = '';
        			if ($record['incident_status_id'] == 10){
		        ...
		        <div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-7">
		                    	<input type="checkbox" class="checkboxes" value="{{$record['hearing_partner']}}"
		                    	 name="partners_incident[hearing_partner]" id="resources_request-hearing_partner" 
		                    	 <?php if($record['hearing_partner'] > 0) echo "checked" ?> /> 
		                    	<span class="small">Involved Employee</span> <br>

		                    	<input type="checkbox" class="checkboxes" value="{{$record['hearing_complainants']}}"
		                    	 name="partners_incident[hearing_complainants]" id="resources_request-hearing_complainants" 
		                    	 <?php if($record['hearing_complainants'] > 0) echo "checked" ?> /> 
		                    	<span class="small">Complainants</span> <br>

		                    	<input type="checkbox" class="checkboxes" value="{{$record['hearing_witnesses']}}"
		                    	 name="partners_incident[hearing_witnesses]" id="resources_request-hearing_witnesses" 
		                    	 <?php if($record['hearing_witnesses'] > 0) echo "checked" ?> /> 
		                    	<span class="small">Witnesses</span> <br>

		                        <input type="checkbox" class="checkboxes" value="{{$record['hearing_others']}}" 
		                        name="partners_incident[hearing_others]" id="partners_incident-hearing_others" 
		                        <?php if($record['hearing_others'] > 0) echo "checked" ?>  /> <span class="small">Other/s:</span> <br>
		                        <br>
		                        <?php
								...
								<div class="input-group">
									...
									{{ form_dropdown('partners_incident[hearing_others-temp][]',$user_id_options, explode(',', $record['hearing_others-temp']), 'class="form-control select2" data-placeholder="Select..." multiple id="partners_incident-hearing_others-temp"') }}
								</div>
							</div>
						</div>
					</div>
		        ...
		        <div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-7">
	                    		<textarea <?php echo $readonly ?>rows="4" class="form-control" name="partners_incident_nte[hr_remarks]">{{$record['nte_hr_remarks']}}</textarea>
							</div>
						</div>
					</div>
				</div>	
