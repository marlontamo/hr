		...
		<div class="portlet">
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						@if ($hearing_report)
						<li class=""><a href="{{ get_mod_route('hearing') }}">{{ lang('common.personal') }}</a></li>
						@endif
						@if ($hearing_manage)
						<li class="active"><a href="{{ get_mod_route('hearing_manage') }}">{{ lang('common.manage') }}</a></li>
						@endif
						@if ($hearing_admin)
						<li class=""><a href="{{ get_mod_route('hearing_admin') }}">{{ lang('common.admin') }}</a></li>
						@endif
					</ul>
				</div>
			</div>
			...
			<div class="portlet-title">
				<div class="caption">
					...
					{{ lang('hearing_manage.hearing_sched_list') }}
				</div>
