	...
	<ul class="page-breadcrumb breadcrumb">
		...
		<li class="btn-group">
			...
			<ul role="menu" class="dropdown-menu pull-right">
				<li><a href="{{ $mod->url }}"><i class="fa fa-refresh"></i> {{ lang('job_title.refresh') }}</a></li>
				
				<li class="hidden import-button"><a href="javascript:void(0)" onclick="mod_import({{ $mod->mod_id }})"><i class="fa fa-cloud-download"></i> {{ lang('job_title.import') }}</a></li>
				<li class="divider hidden"></li>
				<li class="hidden"><a href="#"><i class="fa fa-cloud-upload"></i> {{ lang('job_title.export') }}</a></li>
			</ul>
		</li>
		<li>
			<i class="fa fa-home"></i>
			<a href="{{ base_url('') }}">{{ lang('job_title.home') }}</a> 
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			<a href="{{ get_mod_route('user_manager') }}">{{ lang('job_title.user_manager') }}</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
