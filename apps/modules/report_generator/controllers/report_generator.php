        ...
        if($result && $result->num_rows() > 0){
         ...
         //Part IV-B Details of Compensation Income and Tax WithHeld from Present Employer
            ...
            // Item #47A
                ...
                $line = 181;
                $pdf->MultiCell(45, 10, 'Tempo Allowance', 0, 'R', false, 0, 100, $line, true, 0, false, false, 0, 'T', true);   
            ...
            // Item #47B
                ...
                $line = 186.8;
                $pdf->MultiCell(46, 10, 'Service Allowance', 0, 'R', false, 0, 100, $line, true, 0, false, false, 0, 'T', true);   
