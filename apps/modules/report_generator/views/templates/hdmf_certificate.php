	...
	<body>
		<div>
			<table>
				...
				<tr>
					<td width="100%">
						<p style="font-size:10;">This is to certify that the following <b>PAG-IBIG Contribution</b> payments have been remitted to PAG-IBIG by <b><?php echo $company; ?></b> for and on behalf of <b><?php echo $emp_name;?> :</b></p>
					</td>
				</tr>
			</table>
			<table cellpadding="1">
            ...
            <table cellpadding="1">
            	...
            	if( isset($detail) ){
	                ...
	                {	
	                    ...
	                    $emp = $value['Hdmf Emp'] ;
	                    $er = $value['Hdmf Com'] ;
	                    $sbr_no = $value['Sbr No Hdmf'];
	                    $dt_paid = !empty($value['Sbr Date Hdmf']) ? date('Y-m-d',strtotime($value['Sbr Date Hdmf'])) : "";
	                    ?>
	                    <tr>
	                        <td width="10%">&nbsp;</td>
