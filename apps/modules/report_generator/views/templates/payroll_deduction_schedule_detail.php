...
<table>
    ...
    foreach ($results as $dtl_res) {
        ...
        if( $transaction_lbl == '' || $transaction_lbl != $dtl_res['Transaction Label'] ) {
            if($transaction_lbl == '') { ?>
                ...
                <tr>
                    <td width="100%"><strong><?php echo $dtl_res['Transaction Label']; ?></strong></td>
                </tr><?php
                $total_line++;
            } else { ?>
        		<tr> 
                ...
                <tr>
                    <td width="50%"  style="text-align:right;"><strong>Total <?php echo $label; ?></strong></td>
    ...
    if($total_line != 40)
    {
        for ($space=1; $space <= (40 - $count); $space++) 
        { ?>
            <tr><td></td></tr>
        <?php }   
    } ?>
