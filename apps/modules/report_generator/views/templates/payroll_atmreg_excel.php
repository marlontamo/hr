...
<table width="100%">
    <tr>
        <td colspan="8" width="100%" style="text-align:center; font-size:10; "><strong><?php echo $company; ?></strong></td>
    </tr>
    <tr>
        <td colspan="8" width="100%" style="text-align:center;"><strong><?php echo $address; ?></strong></td>
    </tr>
    <tr>
        <td colspan="8" width="100%" style="text-align:center; font-size:10; "><strong>ATM Register Report</strong></td>
    </tr>
    <tr>
        <td colspan="8" width="100%" style="font-size:10px;"></td>
    </tr>
    <tr>
        ...
        <td colspan="3" width="35%" style="text-align:left;">Employee Name</td>
...
<table>
    ...
    foreach( $result as $row ): 
        ...
        <tr>
            <td style="text-align:Left;  "><?php echo $cnt_line; ?>.</td>
            <td style="text-align:Left;  "><?php echo $row['Bank Account']; ?></td>
            <td width="20%"  style="text-align:right; "><?php echo number_format( $row['Amount'],2,".",","); ?></td>
            <td colspan="3" style="text-align:left;  "><?php echo $row['Full Name']; ?></td>
    ...
    <tr>
        <td colspan="2" width=" 25%"  style="text-align:left;"><strong>Grand Total :  <?php echo $emp_count; ?></strong></td>
