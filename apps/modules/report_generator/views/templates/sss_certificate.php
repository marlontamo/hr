	...
	<body>
		<div>
			<table>
				...
				<tr>
					<td width="100%">
						<p style="font-size:10;">This is to certify that the following <b>SSS Contribution</b> payments have been remitted to SSS by <b><?php echo $company; ?></b> for and on behalf of <b><?php echo $emp_name;?> :</b></p>
					</td>
				</tr>
			</table>
			<table cellpadding="1">
                ...
                <tr>
                    <td width=" 5%">&nbsp;</td>
                    <td width="15%" style="text-align:center; font-size:10;"><b>Period Covered</b></td>
                    ...
                    <td width="15%" style="text-align:center; font-size:10;"><b>EC</b></td>
            ...
            <table cellpadding="1">
            	...
            	if( isset($detail) ){
	                ...
	                {	
	                    ...
	                    $er = $value['Sss Com'] ;
	                    $ecc = $value['Sss Ecc'] ;
	                    $sbr_no = $value['Sbr No Sss'];
	                    $dt_paid = !empty($value['Sbr Date Sss']) ? date('Y-m-d',strtotime($value['Sbr Date Sss'])) : "";
	                    ?>
	                    <tr>
	                        <td width=" 5%">&nbsp;</td>
		                    <td width="15%" style="text-align:center; font-size:10; "><?php echo $period;?></td>
			                ...
			                <td width="15%" style="text-align:right ; font-size:10; "><?php echo $ecc  != "" ? number_format( $ecc , 2, '.', ',' ) : "0.00";?></td>
