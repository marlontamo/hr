...
<table>
    ...
    <?php   }
            if($cnt == 1){ $cnt++; // add count for header row ?>
                    ...
                    <tr>
                        <td style=" width:100% ; text-align:center ; "><strong>PAYROLL REGISTER (Historical)</strong></td>
                    </tr>
                    <tr>
    ...
    <tr style="background-color: gray;">
        ...
        <td style=" width: 8% ; text-align:right;"><?php echo number_format( $gtNetAmount ,2,'.',','); ?></td>
    </tr>
</table>