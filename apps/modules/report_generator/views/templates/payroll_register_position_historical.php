...
<table>
    ...
    <tr>
        ...
        <td rowspan="2">MISC. </br>AMOUNT</td>
        <td rowspan="2">OVERTIME</td>
        <td rowspan="2">OT %</td>
        <td rowspan="2">OTHER TAX INCOME</td>
        <td rowspan="2">ADJUSTMENT</td>
        <td rowspan="2">GROSS INC.</td>
        <td rowspan="2">W/H</td>
        <td rowspan="2">SSS EE</td>
        <td rowspan="2">MCR EE</td>
        <td rowspan="2">HDMF EE</td>
        <td rowspan="2">OTHER <br/>NON TAX</td>
        <td rowspan="2">LOAN </br>PAYMENTS</td>
        <td rowspan="2">DEDUCTION </br>PAYMENTS</td>
        <td rowspan="2">NET </br>SALARY</td>
    </tr>
    <?php
    $cost_center_lbl = '';
    $count = 0;
