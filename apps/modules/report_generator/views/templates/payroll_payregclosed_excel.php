...
<table>
    ...
    <tr>
        <td colspan="18" align="center" style=" width:100% ;"><strong><?php echo $company; ?></strong></td>
    </tr>
    <tr>
        <td colspan="18" align="center" style=" width:100% ;"><strong>PAYROLL REGISTER (Historical)</strong></td>
    </tr>
    <tr>
        <td colspan="18" align="center" style=" width:100% ;"><strong>PAYROLL PERIOD : <?php echo date("m/d/Y",strtotime($date_from)).'  - '.date("m/d/Y",strtotime($date_to)); ?></strong></td>
    </tr>
    <tr>
...
<?php foreach( $com as $comp => $emp):
    ...
    <tr style="background-color: lightgrey;">
        ...
        <td style=" width: 5% ; text-align:right;"><?php echo  $tHoliday; ?></td>
        <td style=" width: 5% ; text-align:right;"><?php echo  $tOtherEarnings; ?></td>
        <td style=" width: 4.5% ; text-align:right;"><?php echo  $tGross; ?></td>
        <td style=" width: 4.5% ; text-align:right;"><?php echo  $tSSS; ?></td>
        <td style=" width: 4% ; text-align:right;"><?php echo  $tPHIC; ?></td>
        <td style=" width: 5% ; text-align:right;"><?php echo  $tHDMF; ?></td>
        <td style=" width: 5% ; text-align:right;"><?php echo  $tTax; ?></td>
        <td style=" width: 5% ; text-align:right;"><?php echo  $tLoan; ?></td>
        <td style=" width: 6% ; text-align:right;"><?php echo  $tEmployeeLedger; ?></td>
        <td style=" width: 6% ; text-align:right;"><?php echo  $tOtherDeduction; ?></td>
    ...
    <tr style="background-color: gray;">
        ...
        <td style=" width: 4.5% ; text-align:right;"><?php echo  $gtGross; ?></td>
        <td style=" width: 4.5% ; text-align:right;"><?php echo  $gtSSS; ?></td>
        <td style=" width: 4% ; text-align:right;"><?php echo  $gtPHIC; ?></td>
        <td style=" width: 5% ; text-align:right;"><?php echo  $gtHDMF; ?></td>
        ...
        <td style=" width: 8% ; text-align:right;"><?php echo  $gtNetAmount; ?></td>
    </tr>
</table>