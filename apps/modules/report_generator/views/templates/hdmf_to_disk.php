<?php
    ...
    // Header
    $header = 'EH'.$records->{'Pagibig Branch Code'}.$doc_year.str_pad(str_replace('-', '', $records->{'Co Hdmf'}),15," ",STR_PAD_RIGHT).'PMC'.str_pad($company,103," ",STR_PAD_RIGHT).str_pad($records->{'Co Address'},100," ",STR_PAD_RIGHT).str_pad($records->{'Zipcode'},7," ",STR_PAD_RIGHT).str_pad($records->{'Contact No'},7," ",STR_PAD_RIGHT)."\r\n";
