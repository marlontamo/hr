<?php
    ...
    foreach ($result as $value):
            ...
            <tr>
                <td width="100%" >
                    <table>
                        ...
                        <tr>
                            <td width="1%"></td>
                            <td width="95%" align="left" style="font-size: 10;"><b><?php echo $value->Company;?></b></td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                <td width="100%" >
                    <table>
                        <tr>
                            <td width="1%"></td>
                            <td width="95%" align="left" style="font-size: 6;"><?php echo $value->Address;?>, <?php echo $value->City;?></td>
                        </tr>
                        <tr>
                            <td width="1%"></td>
                            <td width="95%" style="text-align:left; font-size:5;">Phone No: <?php echo $value->{'Phone No'}; ?> Fax No: <?php echo $value->{'Fax No'};?></td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table>
            ...
            <tr>
                <td style="width:  50%" align="left" font-size="10"><b>&nbsp;&nbsp;Employee ID: <?php echo $value->{'Id Number'}?></b></td>
                <td style="width:  50%"><b>Period Covered : <?php echo date( 'm/d/y', strtotime($value->{'Date From'}))?> - <?php echo date( 'm/d/y', strtotime($value->{'Date To'}))?></b></td>
            </tr>
