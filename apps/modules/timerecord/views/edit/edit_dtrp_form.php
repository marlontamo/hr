                    ...
                    <div class="portlet-body form">
                            ...
                            <div class="form-body">                      	
                            	<div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <select <?= $disabled?> id="dtrp_type" name="dtrp_type" class="form-control selectme3" data-placeholder="Select...">
  	...
  	$("#date_from").change(function(){ 
  		if($("#dtrp_type").val() != 3){
	  		if($(this).val() != "" && $("#date_to").val() != ""){
  				get_shift_details($(this).val(), $("#date_to").val(), 11, $('#dtrp_type').val());
  			}
  		}
	});
