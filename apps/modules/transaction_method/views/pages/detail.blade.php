...
<div class="row">
    ...
    <div class="portlet-body form">         
        <div class="form-group">
            ...
            <div class="col-md-7">                          
                <input type="text" disabled="disabled" class="form-control" name="payroll_transaction_method[payroll_transaction_method]" id="payroll_transaction_method-payroll_transaction_method" value="{{ $record['payroll_transaction_method.payroll_transaction_method'] }}" placeholder="Enter Method Name"/>               
            </div>  
        </div>          
        <div class="form-group">
            <label class="control-label col-md-3">Description</label>
            <div class="col-md-7">                          
                <textarea class="form-control" disabled="disabled" name="payroll_transaction_method[description]" id="payroll_transaction_method-description" placeholder="Enter Description" rows="4">{{ $record['payroll_transaction_method.description'] }}</textarea>               
            </div>  
        </div>  
    </div>
