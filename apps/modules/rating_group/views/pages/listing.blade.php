...
@section('page-breadcrumb')
	<ul class="page-breadcrumb breadcrumb">
		...
		<li>
			<a href="{{ get_mod_route('performance_master') }}">{{ lang('rating_group.performance_master') }}</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
	...
	<div class="col-md-9">
		<div class="portlet">
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						...
						<li class="active"><a href="{{ get_mod_route('rating_group') }}">Rating Scale</a></li>
						@endif
						@if ($allow_performance)
						<li class=""><a href="{{ get_mod_route('performance') }}">Performance Type</a></li>
						@endif
						@if ($allow_notification)
						<li class=""><a href="{{ get_mod_route('performance_notification') }}">Notification</a></li>
						@endif
					</ul>
				</div>
			</div>
			...
			<div class="portlet-title">
				<div class="caption"><i class="fa {{ $mod->icon}}"></i>List of Rating Scales</div>
