<div class="portlet">
	<div class="portlet-title">
		<div class="caption">{{ lang('incident_manage.ir') }}</div>
		<div class="tools"><a class="collapse" href="javascript:;"></a></div>
	</div>
		<div class="portlet-body form">			<div class="form-group">
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('incident_manage.involved') }}</label>
				<div class="col-md-7"><?php									                            		$db->select('user_id,full_name');
	                            ...
	                            {{ form_dropdown('partners_incident[involved_partners][]',$partners_incident_involved_partners_options, explode(',', $record['partners_incident.involved_partners']), 'class="form-control select2" data-placeholder="Select..." multiple id="partners_incident-involved_partners"') }}
	                        </div> 				</div>	
			</div>			<div class="form-group">
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('incident_manage.offense') }} </label>
				...
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('incident_manage.complainants') }}</label>
				<div class="col-md-7"><?php									                            		$db->select('user_id,full_name');
	                            			                            		$db->order_by('full_name', '0');
	                            		$db->where('deleted', '0');
				...
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('incident_manage.date_time_offense') }}</label>
				...
				<label class="control-label col-md-3">{{ lang('incident_manage.attachments') }}</label>
				<div class="col-md-7">							<div data-provides="fileupload" class="fileupload fileupload-new" id="partners_incident-attachments-container">
								...
								<div class="input-group">
									...
									<span class="btn default btn-file">
										<span class="fileupload-new"><i class="fa fa-paper-clip"></i> {{ lang('incident_manage.select_file') }}</span>
	...
	<div class="portlet-title">
		<div class="caption">{{ lang('incident_manage.details_offense') }}</div>
		<div class="tools"><a class="collapse" href="javascript:;"></a></div>
	</div>
		<div class="portlet-body form">			<div class="form-group">
				<label class="control-label col-md-3">{{ lang('incident_manage.witnesses') }}</label>
				<div class="col-md-7"><?php									                            		$db->select('user_id,full_name');
	                            			                            		$db->order_by('full_name', '0');
	                            		$db->where('deleted', '0');
				...
				<label class="control-label col-md-3">{{ lang('incident_manage.location') }}</label>
				...
				<label class="control-label col-md-3">{{ lang('incident_manage.details_violation') }} </label>
				...
				<label class="control-label col-md-3">{{ lang('incident_manage.damages') }} </label>
