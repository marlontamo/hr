<div class="portlet">
	<div class="portlet-title">
		<div class="caption">{{ lang('incident_manage.ir') }}
	...
	<div class="portlet-body form">
		<div class="form-body">
	    	<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('incident_manage.involved') }} :</label>
	        ...
	        <div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('incident_manage.offense') }} :</label>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('incident_manage.complainants') }} :</label>
						<div class="col-md-7 col-sm-7">
							<?php 
								$get_users = " SELECT us.*, pos.position FROM users_profile us
											JOIN ww_users_position pos ON us.position_id = pos.position_id
				...
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('incident_manage.date_time_offense') }} :</label>
			...
			<div class="row">
				<div class="col-md-12">
	                <div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('incident_manage.attachments') }} :</label>
...
<div class="portlet">
	<div class="portlet-title">
		<div class="caption">{{ lang('incident_manage.details_offense') }}
			<!-- <span class="text-muted small">view</span> -->
		</div>
		<div class="tools"><a class="collapse" href="javascript:;"></a></div>
	</div>
	<p class="margin-bottom-25">{{ lang('incident_manage.note_detail_offense') }}</p>
	<div class="portlet-body form">
		<div class="form-body">
	    	<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('incident_manage.witnesses') }} :</label>
						<div class="col-md-8 col-sm-8">
							<?php 
	        ...
	        <div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('incident_manage.location') }} :</label>
						<div class="col-md-7 col-sm-7">
	        ...
	        <div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('incident_manage.details_violation') }} :</label>
						<div class="col-md-7 col-sm-7">
	        ...
	        <div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('incident_manage.damages') }} :</label>
						<div class="col-md-7 col-sm-7">
...
<div class="portlet">
	<div class="portlet-title">
		<div class="caption">{{ lang('incident_manage.supervisor') }}</div>
		<div class="tools">
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-7">
								<?php
									$readonly = '';
									if ($record['approver_status_id'] >= 4){
										$readonly = 'readonly="readonly';
									}
								?>
	                    		<textarea <?php echo $readonly ?> rows="4" class="form-control" name="partners_incident_approver[comment]">{{$record['app_remarks']}}</textarea>
							</div>
						</div>
					</div>
				</div>
