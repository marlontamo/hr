...
class Performance extends MY_PrivateController
{
	public function __construct()
	{
		$this->load->model('performance_model', 'mod');
		parent::__construct();
	}
    ...
    public function index()
    {
        ...
        $data['allow_performance'] = isset($this->permission['list']) ? $this->permission['list'] : 0;
