...
T4.recruit_status as "recruitment_manpower_plan_status_id", 
...
LEFT JOIN `ww_recruitment_status` T4 ON `T4`.`recruit_status_id` = `ww_recruitment_manpower_plan`.`status_id`
