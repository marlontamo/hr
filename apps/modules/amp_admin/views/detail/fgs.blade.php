<div class="portlet">
	<div class="portlet-title">
		...
		<input type="hidden" value="detail" name="view_type" id="view_type">
	</div>
	<div class="portlet-body form">
		<div class="form-group">
			<label class="control-label col-md-4"><span class="required">* </span>{{ lang('annual_manpower_planning.year') }}</label>
			<div class="col-md-5">
				<input type="text" disabled class="form-control" name="recruitment_manpower_plan[year]" id="recruitment_manpower_plan-year" value="{{ $record['recruitment_manpower_plan.year'] }}" placeholder="Enter Year"/>
			</div>	
		</div>
		<div class="form-group">
			...
			<div class="col-md-5"><?php
        		...
        		<div class="input-group hidden">
                    ...
                    {{ form_dropdown('recruitment_manpower_plan[company_id]',$recruitment_manpower_plan_company_id_options, $record['recruitment_manpower_plan.company_id'], 'class="form-control select2me" data-placeholder="Select..." id="recruitment_manpower_plan-company_id" disabled') }}
                </div>
            </div>	
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-5"><?php
				...
				<div class="input-group">
					<span class="input-group-addon"><i class="fa fa-list-ul"></i></span>
					{{ form_dropdown('recruitment_manpower_plan[department_id]',$recruitment_manpower_plan_department_id_options, $record['recruitment_manpower_plan.department_id'], 'class="form-control select2me" data-placeholder="Select..." id="recruitment_manpower_plan-department_id" disabled') }}
				</div> 				
			</div>	
		</div>			
		...
		<div class="form-group">
			...
			<div class="col-md-5">
				<div data-provides="fileupload" class="fileupload fileupload-new" id="recruitment_manpower_plan-attachment-container">
                    ...
                    <span class="btn default btn-sm btn-file hidden">
			                                            		...
			                                            		if(is_array($new_plans)){
								                            		foreach ($new_plans as $plan): ?>
								                            			<tr class="count_newjobs">
																            <td>
																                <input type="text" name="new_position[position][]" maxlength="64" value="{{ $plan->position }}" class="form-control" disabled>
																            </td>
																            <td>
																                <?php echo form_dropdown('new_position[employment_status_id][]', $employment_statuss, $plan->employment_status_id, 'class="form-control select2me" data-placeholder="Select..." disabled') ?>   
																            </td>
																            <td>
																                <?php echo form_dropdown('new_position[job_class_id][]', $job_classes, $plan->job_class_id, 'class="form-control select2me" data-placeholder="Select..." disabled') ?>   
																            </td>
																            <td>
																                <?php echo form_dropdown('new_position[month][]', $months, $plan->month, 'class="form-control select2me" data-placeholder="Select..." disabled') ?>   
																            </td>
																            <td>
																                <input type="text" maxlength="64" name="new_position[budget][]" value="{{ $plan->budget }}" class="form-control" disabled>
																            </td>													            
																            <td>
																                <?php echo form_dropdown('new_position[company_id][]', $users_companys, $plan->company_id, 'class="form-control select2me" data-placeholder="Select..." disabled') ?>   
																            </td>
																           <!--  <td>
...
<table style="display:none">
    <tbody class="new-job-row-template">
        <tr class="count_newjobs">
            ...
            <td>
                <?php echo form_dropdown('new_position[job_rank_id][]', $job_ranks, '', 'class="form-control select2menow dontserializeme" data-placeholder="Select..."') ?>   
            </td>
            <td>
