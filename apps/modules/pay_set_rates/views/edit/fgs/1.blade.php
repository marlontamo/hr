<div class="portlet">
	<div class="portlet-title">
		...
		<div class="portlet-body form">			<div class="form-group">
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('pay_steps_rates.pay_steps_rates') }}</label>
				...
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('pay_steps_rates.pay_steps_rates_code') }}</label>
