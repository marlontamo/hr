<tr class="record">
    ...
    <td>
        <a id="users_pay_set_rates_pay_set_rates" href="<?php echo $detail_url; ?>"><?php echo $users_pay_set_rates_pay_set_rates; ?></a>
        <br>
        <span id="users_pay_set_rates_pay_set_rates_code" class="small"><?php echo $users_pay_set_rates_pay_set_rates_code; ?></span>
    </td>
    <td class="hidden-xs">

        <span id="users_pay_set_rates_status_id;" <?php echo $users_pay_set_rates_status_id == 'Active' ? 'class="badge badge-success"' : 'class="badge badge-error"' ; ?>><?php echo $users_pay_set_rates_status_id; ?></span>
    </td>
    <td>
        <div class="btn-group">

            <a class="btn btn-xs text-muted" href="{{ $edit_url }}"><i class="fa fa-pencil"></i> {{ lang('pay_steps_rates.edit') }}</a>
        </div>
        <div class="btn-group">

            <a class="btn btn-xs text-muted" href="#" data-close-others="true" data-toggle="dropdown"><i class="fa fa-gear"></i> {{ lang('pay_steps_rates.options') }}</a>
