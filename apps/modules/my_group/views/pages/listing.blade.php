		...
		<div class="col-md-9">
			<div class="portlet">
				<div class="portlet-title">
					<div class="caption"><i class="fa {{ $mod->icon}}"></i>{{ lang('common.list') }} Groups</div>
					<div class="caption" id="head-caption">&nbsp;</div>
					<div class="actions">
						@if( isset( $permission['add']) && $permission['add'] )
							<button id="goadd" onclick="quick_add()" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Create Group</button>
						@endif
