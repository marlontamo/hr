	...
	<div class="col-md-9">
		<div class="portlet">
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						...
						<li class=""><a href="{{ get_mod_route('appraisal_master') }}">Category</a></li>
						@endif
						...
						<li class="active"><a href="{{ get_mod_route('competency_level') }}">Level</a></li>
						@endif
					</ul>
				</div>
			</div>
			...
			<div class="portlet-title">
				<div class="caption"><i class="fa {{ $mod->icon}}"></i>List of Levels</div>
