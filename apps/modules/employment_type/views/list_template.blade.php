...
<!-- <td class="hidden-xs">
    ...
    <td>
        <a id="partners_employment_type_employment_type" href="<?php echo $detail_url; ?>" ><?php echo $partners_employment_type_employment_type; ?></a>
    </td>
    <td class="hidden-xs">
        <span id="partners_employment_type_status_id" <?php echo $partners_employment_type_status_id == 'Active' ? 'class="badge badge-success"' : 'class="badge badge-error"' ; ?> ><?php echo $partners_employment_type_status_id; ?></span>
    </td>
    <td>
        <div class="btn-group">
            <a class="btn btn-xs text-muted" href="{{ $edit_url }}"><i class="fa fa-pencil"></i> {{ lang('employment_type.edit') }}</a>
        </div>
        <div class="btn-group">
            <a class="btn btn-xs text-muted" href="#" data-close-others="true" data-toggle="dropdown"><i class="fa fa-gear"></i> {{ lang('employment_type.options') }}</a>
