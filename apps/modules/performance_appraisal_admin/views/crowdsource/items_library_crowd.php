		...
		foreach( $rows as $row )
		{
			...
			<tr>
				<td class="contributor contributor-<?php echo $contributor->contributor_id?>" contributor_id="<?php echo $contributor->contributor_id?>">
					...
					<div class="btn-grp">
						<a href="javascript:get_discussion_form(<?php echo $appraisal_id?>, <?php echo $section_id?>, <?php echo $user_id?>, <?php echo $contributor->contributor_id?>, false)" class="btn btn-info btn-xs"> Discussion logs</a>
       				</div>		
				</td> <?php
					...
					case 6:
						switch( $rindex )
						{
							...
							case 1:
								...
								break;
							case 2:
								echo '<td><input type="text" class="form-control section_cs_war" section_id="'.$section_id.'" readonly></td>';
								break;
							default:
								echo '<td></td>';
						}
