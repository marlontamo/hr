...
@section('page-header')
	...
	<div class="col-md-12">
		...
		<ul class="page-breadcrumb breadcrumb">
			<li class="btn-group">
				<a href="{{ $record['back_url'] }}"><button class="btn blue" type="button">
				<span>Back</span>
				</button></a>
			</li>
			<li>
	...
	<div class="row">
        <div class="col-md-9">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-md-7 col-sm-7">
													<span><?php echo date('F d, Y - D',strtotime($record['created_on'])) ?></span>
												</div>
											</div>
										</div>
									</div>
                ...
                <div class="portlet">
					...
					<p class="margin-bottom-25">This section contains details on the earned additional leave credit.</p>
					<div class="portlet-body">
                        ...
                        <div class="form-body">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-4 text-right text-muted">Credit :</label>
										<div class="col-md-7 col-sm-7">
											<span>{{ $record['credit'] or '' }} </span>
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-4 text-right text-muted">Consumed :</label>
										<div class="col-md-7 col-sm-7">
											<span>{{ $record['consumed'] or ''}} </span>
										</div>
									</div>
								</div>
							</div>
							@if( isset($record['consumed']) && strtolower($record['consumed']) == 'yes' )
                            <div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-4 text-right text-muted">Expiration :</label>
										<div class="col-md-7 col-sm-7">
											<span>{{ date( 'F d, Y', strtotime($record['expiration_date']) ) }} 
												- <?php echo date('D',strtotime($record['expiration_date'])); ?></span>
										</div>
									</div>
								</div>
							</div>
				...
				<!--End-->
	                            <div class="form-actions fluid" align="center">
                                    <div class="row">
                                        <div>
                                            <div>
	                                        	<a href="{{ $record['back_url'] }}" class="btn btn-default btn-sm">Back to list</a>
	                                        </div>
                                        </div>
                                    </div>
                                </div>
