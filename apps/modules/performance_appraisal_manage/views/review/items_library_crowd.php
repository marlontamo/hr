	...
	if( $show_total )
	{
		foreach( $rows as $rindex => $row )
		{
			...
			foreach( $result as $index => $col )
			{
				...
				{
					case 5:
						echo '<td><input type="text" class="form-control average-cs-rating" name="average-cs-rating" item_id="'.$row->item_id.'" readonly></td>';
						break;
					case 6:
						switch( $rindex )
						{
							case 0:
								echo '<td><input type="text" class="form-control section_cs_avg_rating" name="section_cs_avg_rating" section_id="'.$section_id.'" readonly></td>';
								break;
							case 1:
								echo '<td><input type="text" class="form-control section_cs_weight" name="section_cs_weight" section_id="'.$section_id.'" readonly value="'.$section->weight.'%"></td>';
								break;
							case 2:
								echo '<td><input type="text" class="form-control section_cs_war weight_rating-total" name="weight_rating-total" section_id="'.$section_id.'" readonly></td>';
								break;
							default:
								echo '<td></td>';
						}
