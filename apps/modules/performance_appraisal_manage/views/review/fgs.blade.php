									...
									<tr class="success">
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ $appraisee->fullname }}" name="appraisee_fullname" disabled>
												</div>
											</div>
										</td>
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ $appraisee->immediate }}" name="appraisee_immediate" disabled>
												</div>
											</div>
										</td>
									</tr>
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ $appraisee->position }}" name="appraisee_position" disabled>
												</div>
											</div>
										</td>
										<td>
											<div class="form-group">
												<label class="control-label col-md-3 bold">{{ lang('performance_appraisal_manage.job_title') }}</label>
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ $appraisee->immediate_position }}"  name="appraisee_immediate_position" disabled>
												</div>
											</div>
										</td>
									</tr>
									<tr class="success">
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ date('M d, Y', strtotime( $appraisee->effectivity_date ) ) }}" name="appraisee_effectivity_date" disabled>
												</div>
											</div>
										</td>
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ date('M d, Y', strtotime( $appraisee->date_from ) ) }} to {{ date('M d, Y', strtotime( $appraisee->date_to ) ) }}" name="appraisee_date_to" disabled>
												</div>
											</div>
										</td>
									</tr>
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ $appraisee->company }}" name="appraisee_company" disabled>
												</div>
											</div>
										</td>
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="<?php if( !empty($appraisee->date) ) echo date('M d, Y', strtotime( $appraisee->date ) )?>"  name="appraisee_date" disabled>
												</div>
											</div>
										</td>
									</tr>
										...
										<div class="panel panel-success">
											...
											switch( $child->section_type_id )
											{
												...
												case 4: //library crowd ?>
													...
													break;
												case 5: //summary ?>
													@include('review/sections/summary', array('sections' => $sections, 'header' => $child->header, 'footer' => $child->footer))<?php 
													break;
									...
									<tr class="success">
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ $appraisee->fullname }}" name="appraisee_company" disabled>
												</div>
											</div>
										</td>
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ $appraisee->immediate }}" name="appraisee_fullname" disabled>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ $appraisee->company }}" name="appraisee_fullname" disabled>
												</div>
											</div>
										</td>
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="<?php if( !empty($appraisee->selfrate_date) ) echo date('M d, Y', strtotime( $appraisee->selfrate_date ) )?>" name="appraisee_selfrate_date" disabled>
												</div>
											</div>
										</td>
									</tr>
            ...
            <div class="row">
                <div class="col-md-12">
					@if( $appraisee->to_user_id == $user['user_id'] && $appraisee->period_status )
	                	@if( $appraisee->status_id == 5 || $appraisee->status_id == 3 || $appraisee->status_id == 1)
		                    <div class="col-md-offset-4 col-md-8">
								...
								<button type="button" class="btn blue btn-sm" onclick="change_status( $(this).closest('form'), 1)"><i class="fa fa-check"></i> {{ lang('common.draft') }}</button>
	                    ...
	                    @else
		                    <div class="col-md-offset-5 col-md-7">
		                    	<button type="button" class="btn yellow btn-sm" onclick="get_observations( {{$appraisee->year}}, {{$appraisee->user_id}}, '{{$appraisee->fullname}}' )"><i class="fa fa-rss"></i> {{ lang('performance_appraisal_manage.observations') }}</button>
		                    	<!-- <button type="button" class="btn blue btn-sm" onclick="view_discussion( $(this).closest('form'), '' )"> {{ lang('performance_appraisal_manage.discussion_logs') }}</button> -->
		                    	<a class="btn default btn-sm" href="{{ $mod->url }}">{{ lang('common.back') }}</a>
		                    </div>
	                    @endif
	                @else
