									...
									<tr class="success">
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ $appraisee->fullname }}" disabled>
												</div>
											</div>
										</td>
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ $appraisee->immediate }}" disabled>
												</div>
											</div>
										</td>
									</tr>
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ $appraisee->position }}" disabled>
												</div>
											</div>
										</td>
										<td>
											<div class="form-group">
												<label class="control-label col-md-3 bold">{{ lang('performance_appraisal_manage.job_title') }}</label>
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ $appraisee->immediate_position }}"  disabled>
												</div>
											</div>
										</td>
									</tr>
									<tr class="success">
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ date('M d, Y', strtotime( $appraisee->effectivity_date ) ) }}" disabled>
												</div>
											</div>
										</td>
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ date('M d, Y', strtotime( $appraisee->date_from ) ) }} to {{ date('M d, Y', strtotime( $appraisee->date_to ) ) }}" disabled>
												</div>
											</div>
										</td>
									</tr>
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="{{ $appraisee->company }}" disabled>
												</div>
											</div>
										</td>
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="<?php if( !empty($appraisee->date) ) echo date('M d, Y', strtotime( $appraisee->date ) )?>"  disabled>
												</div>
											</div>
										</td>
									</tr>
										...
										<div class="panel panel-success">
											...
											switch( $child->section_type_id )
											{
												case 2: //balance Scorecard ?>
													@include('appraisers_review/sections/balance_scorecard', array('section_id' => $child->template_section_id, 'header' => $child->header, 'footer' => $child->footer))<?php 
													break;
												case 3: //library ?>
													@include('appraisers_review/sections/library', array('section_id' => $child->template_section_id, 'header' => $child->header, 'footer' => $child->footer))<?php 
													break;
												case 4: //library crowd ?>
													@include('appraisers_review/sections/library_crowd', array('section_id' => $child->template_section_id, 'header' => $child->header, 'footer' => $child->footer))<?php 
													break;
												case 5: //summary ?>
													@include('appraisers_review/sections/summary', array('sections' => $sections, 'header' => $child->header, 'footer' => $child->footer))<?php 
													break;
												case 6: //supervisor summary ?>
													@include('appraisers_review/sections/sup_summary', array('appraisee' => $appraisee, 'header' => $child->header, 'footer' => $child->footer))<?php 
													break;
												case 7: //partner summary ?>
													@include('appraisers_review/sections/partner_summary', array('appraisee' => $appraisee, 'header' => $child->header, 'footer' => $child->footer))<?php 
													break;
												case 8: //personnel action ?>
													@include('appraisers_review/sections/personnel_action', array('section_id' => $child->template_section_id, 'header' => $child->header, 'footer' => $child->footer))<?php 
													break;
												default:
											} ?>
										</div> <?php
									...
									<tr>
										...
										<td>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" value="<?php if( !empty($appraisee->selfrate_date) ) echo date('M d, Y', strtotime( $appraisee->selfrate_date ) )?>"  disabled>
												</div>
											</div>
										</td>
									</tr>
