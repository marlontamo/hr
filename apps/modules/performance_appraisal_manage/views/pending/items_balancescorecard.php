			...
			switch( $col->uitype_id )
			{
				...
				case 6:
					if( $size > 0 )
					{
						...
						echo '<td><input type="text" class="form-control weighted_rating-field" name="appraisal_field['.$col->section_column_id.']['.$child->item_id.']" value="'.$value.'" disabled></td>';
					}
					else{
						$where = array(
							'appraisal_id' => $appraisal_id,
						...
						echo '<td><input type="text" class="form-control weighted_rating-field" name="appraisal_field['.$col->section_column_id.']['.$row->item_id.']" value="'.$value.'" disabled></td>';
					}
					break;
				case 7: //weight
					if( $size > 0 )
		...
		foreach( $result as $index => $col )
		{
			switch( $col->uitype_id )
			{
				...
				case 5:
					...
					break;
				case 6:
					echo '<td><input type="text" class="form-control weight_rating-total" name="weight_rating-total" value="" disabled></td>';
					break;
				case 7:
					echo '<td><input type="text" class="form-control weight-total" name="weight-total" value="" disabled></td>';
					break;
			}
		}
		echo '</tr>';?>
