		...
		@foreach( $sections as $section )
			...
			@if( !empty( $section->weight ) )
				<tr section_id="{{ $section->template_section_id }}">
					...
					<td>
						<input type="text" class="form-control summary-section" name="summary_section_id" section_id="{{ $fstchild->template_section_id }}" readonly>
					</td>
				</tr>
				...
				@foreach( $section->children as $child )
					@if( !empty( $child->weight ) )
						<tr section_id="{{ $section->template_section_id }}">
							...
							<td>
								<input type="text" class="form-control summary-section" name="summary_template_section_id" section_id="{{ $child->template_section_id }}" readonly>
							</td>
						</tr>
					@endif
				@endforeach
