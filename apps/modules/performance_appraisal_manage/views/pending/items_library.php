<?php
								...
								<table class="table">
									...
									<tbody class="tripart-<?php echo $row->item_id?>"> <?php
										...
										foreach( $pdps->result() as $pdp ):?>
											...
											<td>
												<textarea name="pdp_comment[<?php echo $row->item_id?>][<?php echo $col->section_column_id?>][]" rows="3" class="form-control"><?php echo $pdp->comment?></textarea>
											</td>
											<td>
	...
	if( $show_total )
	{
		...
		echo '<td align="right"><input type="text" value="'.$section->weight.'%" readonly="" section_id="'.$section_id.'" class="form-control section_weight"></td>';
		echo '</tr>';
		echo '<tr class="total-row success">';
		echo '<td colspan="'.(sizeof($result)-2).'" ></td>';
		echo '<td align="right">WEIGHTED AVERAGE RATING</td>';
		echo '<td align="right"><input type="text" readonly="" section_id="'.$section_id.'" class="form-control section_war weight_rating-total"></td>';
		echo '</tr>';
	}		