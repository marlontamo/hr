...
, IF(ww_partners_incident_nte.category = "partner", "Involved Employee", IF(ww_partners_incident_nte.category = "complainants", "Complainants", "Witness")) AS label 
...
AND ww_partners_incident_nte.user_id = {$user_id} AND ww_partners_incident_nte.category IN ("partner", "witness", "others", "complainants")
