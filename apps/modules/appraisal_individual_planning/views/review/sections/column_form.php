                ...
                <form class="form-horizontal" id="column-form">
                    ...
                    <div class="form-body">                        
                        <div class="form-group">
                            <label class="control-label col-md-3"><?=lang('appraisal_individual_planning.col_title') ?><span class="required">*</span></label>
                            <div class="col-md-7">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3"><?=lang('appraisal_individual_planning.sequence')?><span class="required">*</span></label>
                            <div class="col-md-7">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3"><?=lang('appraisal_individual_planning.ui_type')?><span class="required">*</span></label>
                            <div class="col-md-7">
                                <?php
                                ...
                                <div class="help-block small">
                                    {<?=lang('appraisal_individual_planning.select_uitype')?>
                                </div>
                            </div>
                        </div>
