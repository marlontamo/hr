...
<script src="{{ theme_path() }}plugins/ckeditor/ckeditor.js" type="text/javascript" ></script>
<script src="{{ theme_path() }}plugins/jquery-multicheckbox/jquery.multiselect.min.js" type="text/javascript" ></script>
<script src="{{ theme_path() }}plugins/ckfinder/ckfinder.js" type="text/javascript" ></script>
<script src="{{ theme_path() }}plugins/jquery-multicheckbox/jquery.multiselect.min.js" type="text/javascript" ></script>
