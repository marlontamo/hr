...
class Policies_procedures extends MY_PrivateController
{
	public function __construct()
	{
		$this->load->model('policies_procedures_model', 'mod');
		parent::__construct();
	}
    ...
    public function index()
    {
        ...
        $this->load->model('policies_procedures_admin_model', 'policies_mod');
