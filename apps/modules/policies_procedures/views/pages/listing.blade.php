		...
		<div class="portlet">
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						@if ($policies)
						<li class="active"><a href="{{ get_mod_route('policies_procedures') }}">{{ lang('common.personal') }}</a></li>
						@endif
						@if ($policies_admin)
						<li class=""><a href="{{ get_mod_route('policies_procedures_admin') }}">{{ lang('common.admin') }}</a></li>
						@endif
					</ul>
				</div>
			</div>
			...
			<div class="portlet-title">
				<div class="caption">
					...
					{{ lang('policies_procedures.pol_proc') }}
				</div>
		...
		<div class="portlet">
			<div class="clearfix margin-bottom-20">
				...
				<div class="actions margin-top-20 clearfix">
					<span class="pull-right"><a class="text-muted" id="trash" href="javascript:view_trash()">Trash Folder <i class="fa fa-trash-o"></i></a></span>
				</div>
			</div>
