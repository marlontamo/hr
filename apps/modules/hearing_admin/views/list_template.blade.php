<tr class="record">
	...
	<td>
		...
		<br />
		<span class="small text-muted">{{ lang('hearing_admin.involved') }} </span>
		<?php
		}
		?>
	</td>
    ...
    <td class="hidden-xs">
    	@if(strtotime($nte_hearing_date))
    		<?php echo date("M-d",strtotime($nte_hearing_date)); ?> <span class="text-muted small"><?php echo date("D",strtotime($nte_hearing_date)); ?></span><br>
        	<span class="text-muted small"><?php echo date("Y",strtotime($nte_hearing_date)); ?></span>
    	@endif
    </td>
