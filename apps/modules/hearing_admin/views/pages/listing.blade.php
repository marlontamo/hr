		...
		<div class="portlet">
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						...
						@endif
						@if ($hearing_manage)
						<li class=""><a href="{{ get_mod_route('hearing_manage') }}">{{ lang('common.manage') }} </a></li>
						@endif
						@if ($hearing_admin)
						<li class="active"><a href="{{ get_mod_route('hearing_admin') }}">{{ lang('common.admin') }} </a></li>
						@endif
					</ul>
				</div>
			</div>
			...
			<div class="portlet-title">
				<div class="caption">
					...
					{{ lang('hearing_admin.hearing_sched_list') }}
				</div>
