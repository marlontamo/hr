...
, (SELECT hearing_date FROM ww_partners_incident_hearing WHERE `ww_partners_incident_hearing`.`incident_id` = ww_partners_incident.incident_id LIMIT 1) as nte_hearing_date 
