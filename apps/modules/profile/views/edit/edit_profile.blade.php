...
@section('page_styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ theme_path() }}plugins/jquery-tags-input/jquery.tagsinput.css" />
                        ...
                        <div class="portlet sale-summary margin-bottom-0">
                            <div class="portlet-body">
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                        <a href="{{ get_mod_route('profile') }}" class="btn icn-only green">Done Editing </a>
...
@section('view_js')
    ...
    <script>
        ...
        jQuery(document).ready(function() {    
            ...
            $('#users_profile_public-interest').tagsInput({
            width: 'auto',
