...
<div class="row">
    ...
    <div class="portlet-body form">         
        <div class="form-group">
            ...
            <div class="col-md-7">                          
                <input type="text" disabled="disabled" class="form-control" name="payroll_account_type[account_type]" id="payroll_account_type-account_type" value="{{ $record['payroll_account_type.account_type'] }}" placeholder="Enter Account Type"/>              
            </div>  
        </div>          
        <div class="form-group">
            <label class="control-label col-md-3">Description</label>
            <div class="col-md-7">                          
                <textarea class="form-control" disabled="disabled" name="payroll_account_type[description]" id="payroll_account_type-description" placeholder="Enter Description" rows="4">{{ $record['payroll_account_type.description'] }}</textarea>                 
            </div>  
        </div>  
    </div>
