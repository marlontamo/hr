<div class="portlet">
	<div class="portlet-title">
		<div class="caption">{{ lang('nte_admin.nte') }}
	...
	<div class="portlet-body form">
		<div class="form-body">
	    	<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('nte_admin.involved') }} :</label>
	        ...
	        <div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('nte_admin.offense') }} :</label>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('nte_admin.complainants') }} :</label>
						<div class="col-md-7 col-sm-7">
							<?php 
								$get_users = " SELECT us.*, pos.position FROM users_profile us
											JOIN ww_users_position pos ON us.position_id = pos.position_id
				...
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('nte_admin.date_time_offense') }} :</label>
			...
			<div class="row">
				<div class="col-md-12">
	                <div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('nte_admin.attachments') }} :</label>
...
<div class="portlet">
	<div class="portlet-title">
		<div class="caption">{{ lang('nte_admin.details_offense') }}
			<!-- <span class="text-muted small">view</span> -->
		</div>
		<div class="tools"><a class="collapse" href="javascript:;"></a></div>
	</div>
	<p class="margin-bottom-25">{{ lang('nte_admin.note_detail_offense') }}</p>
	<div class="portlet-body form">
		<div class="form-body">
	    	<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('nte_admin.witnesses') }} :</label>
						<div class="col-md-8 col-sm-8">
							<?php 
	        ...
	        <div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('nte_admin.location') }} :</label>
						<div class="col-md-7 col-sm-7">
	        ...
	        <div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('nte_admin.details_violation') }} :</label>
						<div class="col-md-7 col-sm-7">
	        ...
	        <div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('nte_admin.damages') }} :</label>
						<div class="col-md-7 col-sm-7">
...
<div class="portlet">
	<div class="portlet-title">
		<div class="caption">
			{{ lang('nte_admin.complainants_explanation') }}
		</div>
		<div class="tools">
			<a class="collapse" href="javascript:;"></a>
		</div>
	...
	<p class="margin-bottom-25">
		{{ lang('nte_admin.note_complainant') }}
	</p>
	<div class="portlet-body">
		<!-- <form id="immediate_remarks"> -->
        <div class="form-body">
	        @foreach($record['complainants_explanation'] as $complainants)
		        <div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label class="control-label col-md-4 col-sm-4 text-right text-muted">
								{{ lang('nte_admin.complainants_name') }} :
							</label>
							<div class="col-md-7 col-sm-7">
...
<div class="portlet">
	<div class="portlet-title">
		<div class="caption">
			{{ lang('nte_admin.witness_explanation') }}
		</div>
		<div class="tools">
			<a class="collapse" href="javascript:;"></a>
		</div>
...
@if(isset($record['immediate_explanation']['explanation']) &&  $record['immediate_explanation']['explanation'] != '')
<div class="portlet">
	<div class="portlet-title">
		<div class="caption">
			{{ lang('nte_admin.supervisor_explanation') }}
		</div>
		<div class="tools">
			<a class="collapse" href="javascript:;"></a>
		</div>
