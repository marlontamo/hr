...
<!-- 		<div class="form-group">
			...
			<div class="col-md-7">
				...
				<div class="input-group">
					...
					{{ form_dropdown('partners_movement[remarks_print_report_id]',$partners_movement_remarks_print_report_id_options, $record['partners_movement.remarks_print_report_id'], 'class="form-control select2me" data-placeholder="Select..." id="remarks_print_report_id"') }}
				</div> 				
			</div>	
		</div> -->		
		<div class="form-group">
    ...
    <div class="row" align="center">
        <div class="col-md-12">
            <div>
				...
				?>
				<button class="btn green btn-sm" type="button" onclick="save_movement( $(this).closest('form'), 2)"><i class="fa fa-check"></i> Save</button>  
				<?php
					}
				?>                              
