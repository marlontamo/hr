		...
		<div class="col-md-9">
			<div class="portlet">
				<div class="portlet-body">
					<div >
						<ul class="nav nav-tabs ">
							@if ($offense)
							<li class=""><a href="{{ get_mod_route('code_discipline') }}">{{ lang('offense_sanction.offense') }}</a></li>
							@endif
							@if ($sanction)
							<li class="active"><a href="{{ get_mod_route('offence_sanction') }}">{{ lang('offense_sanction.sanction') }}</a></li>
							@endif
						</ul>
					</div>
				</div>
				...
				<div class="portlet-title">
					<div class="caption"><i class="fa {{ $mod->icon}}"></i>{{ lang('offense_sanction.list_of') }} {{ $mod->short_name }}</div>
