<div class="portlet">
	<div class="portlet-title">
		...
		<div class="portlet-body form">			<div class="form-group">
				...
				<div class="col-md-7"><?php									                            		$db->select('offense_sanction_category_id,offense_sanction_category');
	                            			                            		$db->order_by('offense_sanction_category', '0');
	                            		$db->where('deleted', '0');
	                            		$options = $db->get('partners_offense_sanction_category'); 	                            $partners_offense_sanction_sanction_category_id_options = array('' => 'Select...');
				...
				<div class="col-md-7"><?php									                            		$db->select('offense_level_id,offense_level');
	                            ...
	                            {{ form_dropdown('partners_offense_sanction[sanction_level_id]',$partners_offense_sanction_sanction_level_id_options, $record['partners_offense_sanction.sanction_level_id'], 'class="form-control select2me" data-placeholder="Select..." id="partners_offense_sanction-sanction_level_id"') }}
	                        </div> 				</div>	
			</div>			<div class="form-group">
