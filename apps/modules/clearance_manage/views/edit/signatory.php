		...
		<div class="panel panel-info">
			<div class="panel-heading">
				<h3 class="panel-title"><?php echo $value['panel_title'] ?>
					<span class="pull-right "><a class="small text-muted" onclick="delete_signatories(<?php echo $value['clearance_signatories_id']?>)" href="#">{{ lang('common.delete') }}</a></span>
					<span class="pull-right "><a class="small text-muted"> &nbsp;|&nbsp; </a></span>
					<span class="pull-right "><a class="small text-muted"  onclick="add_sign(<?php echo $value['clearance_signatories_id']?>)" href="#">{{ lang('common.edit') }}</a></span>
				</h3>
			</div>
			...
			<table class="table">
				...
				<tr>
					<td class="active"><span class="bold">{{ lang('clearance_manage.accountabilities') }}</td>
					<td>
