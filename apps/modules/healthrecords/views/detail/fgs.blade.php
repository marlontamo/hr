<div class="portlet">
	<div class="portlet-title">
		...
		<div class="portlet-body form">			<div class="form-group">
				...
				<div class="col-md-7">							<input {{ $record['disabled'] }} type="text" class="form-control" name="partners_health_records[health_provider]" id="partners_health_records-health_provider" value="{{ $record['partners_health_records.health_provider'] }}" placeholder="Enter Health Provider" /> 				</div>	
			</div>			<div class="form-group">
				...
				<div class="col-md-7">							<div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
								<input {{ $record['disabled'] }} type="text" class="form-control" name="partners_health_records[date_of_completion]" id="partners_health_records-date_of_completion" value="{{ $record['partners_health_records.date_of_completion'] }}" placeholder="Enter Date of Completion" readonly>
				...
				<div class="col-md-7">	
				@if(!$record['disabled'])						
					<div data-provides="fileupload" class="fileupload fileupload-new" id="partners_health_records-attachments-container">
				...
				@else
					@if( !empty($record['partners_health_records.attachments']) )
						...
						?>	
						<input {{ $record['disabled'] }} type="text" class="form-control" value="@if( isset($f_info['name'] ) ) {{ basename($f_info['name']) }} @endif"/>										
					@endif
				@endif			
				</div>	
			</div>	</div>
	...
	<div class="portlet-title">
		...
		<div class="portlet-body form">			<div class="form-group">
				...
				<div class="col-md-7">							<textarea {{ $record['disabled'] }} class="form-control" name="partners_health_records[findings]" id="partners_health_records-findings" placeholder="Enter Findings" rows="4">{{ $record['partners_health_records.findings'] }}</textarea> 				</div>	
			</div>			<div class="form-group">
				<label class="control-label col-md-3">{{ lang('healthrecords.diagnosis') }}</label>
				<div class="col-md-7">							<textarea {{ $record['disabled'] }} class="form-control" name="partners_health_records[diagnosis]" id="partners_health_records-diagnosis" placeholder="Enter Diagnosis" rows="4">{{ $record['partners_health_records.diagnosis'] }}</textarea> 				</div>	
			</div>			<div class="form-group">
				<label class="control-label col-md-3">{{ lang('healthrecords.reccomendation') }}</label>
				<div class="col-md-7">							<textarea {{ $record['disabled'] }} class="form-control" name="partners_health_records[recommendation]" id="partners_health_records-recommendation" placeholder="Enter Recommendations" rows="4">{{ $record['partners_health_records.recommendation'] }}</textarea> 				</div>	
			</div>	</div>
</div>