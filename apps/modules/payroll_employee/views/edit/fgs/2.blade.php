	...
	<div class="portlet-title">
		...
		<div class="portlet-body form">			<div class="form-group">
				...
				<div class="col-md-7"><?php                                                        		$db->select('week_id,week');
	                            ...
	                            {{ form_dropdown('payroll_partners[sss_week][]',$payroll_partners_sss_week_options, explode(',', $record['payroll_partners.sss_week']), 'class="form-control" data-placeholder="Select..." multiple="multiple" id="payroll_partners-sss_week"') }}
	                        </div> 				</div>	
			</div>	</div>
</div>