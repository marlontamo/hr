<div class="portlet">
	...
	<div class="portlet-body form">			
		<div class="form-group">
			<label class="control-label col-md-3"><span class="required">* </span>{{ lang('bank_settings.bank_type') }}</label>
			<div class="col-md-7">							
		...
		<div class="form-group">
			<label class="control-label col-md-3"><span class="required">* </span>{{ lang('bank_settings.bank_n') }}</label>
			<div class="col-md-7">							
				<input type="text" class="form-control" name="payroll_bank[bank]" id="payroll_bank-bank" value="{{ $record['payroll_bank.bank'] }}" placeholder="{{ lang('bank_settings.bank_n') }}" /> 				
			</div>	
		</div>					
		<div class="form-group">
			<label class="control-label col-md-3"><span class="required">* </span>{{ lang('bank_settings.acc_name') }}</label>
			<div class="col-md-7">							
				<input type="text" class="form-control" name="payroll_bank[account_name]" id="payroll_bank-account_name" value="{{ $record['payroll_bank.account_name'] }}" placeholder="{{ lang('bank_settings.p_acc_name') }}" /> 				
			</div>	
		</div>			
		<div class="form-group">
			<label class="control-label col-md-3"><span class="required">* </span>{{ lang('bank_settings.acc_num') }}</label>
			<div class="col-md-7">							
		...
		<div class="form-group">
			...
			<div class="col-md-7">							
				<textarea class="form-control" name="payroll_bank[description]" id="payroll_bank-description" placeholder="{{ lang('bank_settings.p_description') }}" rows="4">{{ $record['payroll_bank.description'] }}</textarea> 				
			</div>	
		</div>			
		<div class="form-group">
