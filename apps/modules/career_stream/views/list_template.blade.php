...
<!-- <td class="hidden-xs">        <a href="<?php echo $edit_url; ?>">
        ...
        <a id="users_job_class_job_class" href="<?php echo $detail_url; ?>" ><?php echo $users_job_class_job_class; ?></a>
        <br>
        <span id="users_job_class_job_class_code" class="small"><?php echo $users_job_class_job_class_code; ?></span>
    </td>
    <td class="hidden-xs">

        <span id="users_job_class_status_id;" <?php echo $users_job_class_status_id == 'Active' ? 'class="badge badge-success"' : 'class="badge badge-error"' ; ?> ><?php echo $users_job_class_status_id; ?></span>
    </td>
    <td>
        <div class="btn-group">

            <a class="btn btn-xs text-muted" href="{{ $edit_url }}"><i class="fa fa-pencil"></i> {{ lang('career_stream.edit') }}</a>
        </div>
        <div class="btn-group">

            <a class="btn btn-xs text-muted" href="#" data-close-others="true" data-toggle="dropdown"><i class="fa fa-gear"></i> {{ lang('career_stream.options') }}</a>
