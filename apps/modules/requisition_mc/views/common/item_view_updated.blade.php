	...
	<tbody class="item-list">
		@foreach( $items as $item )
			...
			<tr class="warning">
		        ...
		        <td>
		            <input type="text" name="requisition_items[actual_amount][]" value="{{ number_format($item->actual_amount, 2, '.', ',') }}" data-inputmask="'alias': 'decimal', 'autoGroup': true, 'groupSeparator': ',', 'groupSize': 3, 'repeat': 13, 'greedy' : false" class="form-control" readonly>
		        </td>
		        <td></td>
			</tr>
		@endforeach
