				...
				<div class="portlet-body">
					<div >
						<ul class="nav nav-tabs ">
							@if ($appraisal_individual_planning)
								<li><a href="{{ get_mod_route('appraisal_individual_planning') }}">{{ lang('common.personal') }}</a></li>
							@endif
							@if ($performance_planning_manage)
								<li><a href="{{ get_mod_route('performance_planning_manage') }}">{{ lang('common.manage') }}</a></li>
							@endif
							<li class="active"><a href="{{ get_mod_route('performance_planning') }}">{{ lang('common.admin') }}</a></li>
						</ul>
					</div>
				</div>
				<br>							
				<div class="portlet-title">
					<div class="caption"><i class="fa {{ $mod->icon}}"></i>Target Setting</div>
