<tr>
	<td>
		<input type="hidden" name="performance_planning_reminder[reminder_id][]" id="performance_planning_reminder-reminder_id" value=''/>
		<select  class="form-control select2me input-sm" data-placeholder="Select..." name="performance_planning_reminder[notification_id][]" id="performance_planning_reminder-notification_id">
		<?php
	...
	<td>
		...
		<div class="input-group date date-picker" data-date-format="MM dd, yyyy">
			<input type="text" value="<?php echo $date?>" class="form-control reminder_date" name="performance_planning_reminder[date][]" id="performance_planning_reminder-date" placeholder="Enter Date" readonly>
	...
	<td>
		<div class="make-switch" data-on-label="&nbsp;<?php echo lang('performance_planning.on') ?>&nbsp;" data-off-label="&nbsp;<?php echo lang('performance_planning.off') ?>&nbsp;"  data-on="success" data-off="warning">
			<input type="checkbox" value="1" checked="checked" name="performance_planning_reminder[status_id][temp][]" id="performance_planning_reminder-status_id-temp" class="dontserializeme toggle reminder_status"/>
			<input type="hidden" name="performance_planning_reminder[status_id][]" id="performance_planning_reminder-status_id" value="1"/>
		</div>
	</td>
	<td>
		<div data-provides="fileupload" class="fileupload fileupload-new" id="performance_planning_reminder-file-container">
	        <input class="reminder_attach-file" type="hidden" name="performance_planning_reminder[file][]" id="performance_planning_reminder-file" />
	        <div class="input-group">
	            ...
	            <span class="btn default btn-file add_file">
	                ...
	                <input type="file" class="reminder_file" id="performance_planning_reminder-file-fileupload" type="file" name="files[]">
	            </span>
	            <a data-dismiss="fileupload" class="btn red fileupload-exists fileupload-delete small"><i class="fa fa-trash-o"></i> Remove</a>
