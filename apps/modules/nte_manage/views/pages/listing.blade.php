			...
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						@if ($nte_report)
						<li class=""><a href="{{ get_mod_route('nte') }}">{{ lang('common.personal') }}</a></li>
						@endif
						@if ($nte_manage)
						<li class="active"><a href="{{ get_mod_route('nte_manage') }}">{{ lang('common.manage') }}</a></li>
						@endif
						@if ($nte_admin)
						<li class=""><a href="{{ get_mod_route('nte_admin') }}">{{ lang('common.admin') }}</a></li>
						@endif
					</ul>
				</div>
			</div>
