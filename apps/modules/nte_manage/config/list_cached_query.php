...
, ww_partners_incident_nte.user_id as nte_id , ww_partners_incident_nte.category as category 
, IF(ww_partners_incident_nte.category = "partner", "Involved Employee", "Witness") AS label 
, ww_partners_incident_nte.nte_status_id as "nte_status_id"
...
-- AND ww_partners_incident_nte.user_id = {$user_id} AND ww_partners_incident_nte.category IN ("immediate")
