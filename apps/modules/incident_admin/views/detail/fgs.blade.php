...
<div class="portlet">
	<div class="portlet-title">
		<div class="caption">{{ lang('incident_admin.hr_remarks') }}</div>
		<div class="tools">
			<a class="collapse" href="javascript:;"></a>
		</div>
	</div>
	<p class="margin-bottom-25">{{ lang('incident_admin.note_hr_remarks') }}</p>
	        ...
	        <div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 text-right text-muted">
							<span class="required">* </span>
							{{ lang('incident_admin.hr_remarks2') }} :
						</label>
						<div class="col-md-7 col-sm-7">
							<?php
								$readonly = '';
							...
							?>							
                    		<textarea <?php echo $readonly ?> rows="4" class="form-control" name="partners_incident[hr_remarks]">{{$record['hr_remarks']}}</textarea>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-md-12">
					<div class="form-group">
						...
						<div class="col-md-7 col-sm-7">
	                    	...
	                    	<input type="checkbox" class="checkboxes" value="{{$record['nte_immediate']}}"
	                    	 name="partners_incident[nte_immediate]" id="resources_request-nte_immediate" 
	                    	 <?php if($record['nte_immediate'] > 0) echo "checked" ?> /> 
	                    	<span class="small">Immediate Superior</span> <br>
