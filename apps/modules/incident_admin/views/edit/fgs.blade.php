<div class="portlet">
	<div class="portlet-title">
		<div class="caption">{{ lang('incident_admin.ir') }}</div>
		<div class="tools"><a class="collapse" href="javascript:;"></a></div>
	</div>
		<div class="portlet-body form">			<div class="form-group">
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('incident_admin.involved') }}</label>
				...
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('incident_admin.offense') }} </label>
				...
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('incident_admin.date_time_offense') }}</label>
				...
				<label class="control-label col-md-3">{{ lang('incident_admin.attachments') }}</label>
				<div class="col-md-7">							<div data-provides="fileupload" class="fileupload fileupload-new" id="partners_incident-attachments-container">
								...
								<div class="input-group">
									...
									<span class="btn default btn-file">
										<span class="fileupload-new"><i class="fa fa-paper-clip"></i> {{ lang('incident_admin.select_file') }}</span>
	...
	<div class="portlet-title">
		<div class="caption">{{ lang('incident_admin.details_offense') }}</div>
		<div class="tools"><a class="collapse" href="javascript:;"></a></div>
	</div>
		<div class="portlet-body form">			<div class="form-group">
				<label class="control-label col-md-3">{{ lang('incident_admin.witnesses') }}</label>
				<div class="col-md-7"><?php									                            		$db->select('user_id,full_name');
	                            			                            		$db->order_by('full_name', '0');
	                            		$db->where('deleted', '0');
				...
				<label class="control-label col-md-3">{{ lang('incident_admin.location') }}</label>
				...
				<label class="control-label col-md-3">{{ lang('incident_admin.details_violation') }} </label>
				...
				<label class="control-label col-md-3">{{ lang('incident_admin.damages') }} </label>
