	...
	<div class="portlet-title">
		...
		<div class="portlet-body form">			<div class="form-group">
				...
				<div class="col-md-7"><?php									                            		$db->select('user_id,full_name');
	                            ...
	                            {{ form_dropdown('partners_incident[involved_partners]',$partners_incident_involved_partners_options, $record['partners_incident.involved_partners'], 'class="form-control select2me" data-placeholder="Select..." id="partners_incident-involved_partners"') }}
	                        </div> 				</div>	
				...
				<div class="col-md-7"><?php									                            		$db->select('user_id,full_name');
	                            			                            		$db->order_by('full_name', '0');
	                            		$db->where('deleted', '0');
	                            		$options = $db->get('users'); 	                            $partners_incident_complainants_options = array('' => 'Select...');
                        		foreach($options->result() as $option)
                        		{
	                            ...
	                            {{ form_dropdown('partners_incident[complainants]',$partners_incident_complainants_options, $record['partners_incident.complainants'], 'class="form-control select2me" data-placeholder="Select..." id="partners_incident-complainants"') }}
	                        </div> 				</div>	
			</div>			<div class="form-group">
