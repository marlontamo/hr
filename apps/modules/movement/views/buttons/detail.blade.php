<div class="form-actions fluid">
  <div class="row" align="center">
    <div class="col-md-12">
      <div class="">
        @if( isset($permission['edit']) && $permission['edit'] && (in_array($record['partners_movement.status_id'],array(1))))
        	<a type="button" class="btn green btn-sm" href="{{ $mod->url . '/edit/' . $record_id }}"><i class="fa fa-check"></i> {{ lang('common.edit') }}</a>
        @endif
        @if( isset($permission['add']) && $permission['add'] && $record['partners_movement.status_id'] == 1 )
