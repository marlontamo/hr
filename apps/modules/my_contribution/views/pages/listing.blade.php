	...
	<div class="col-md-9">
		<div class="portlet">
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						...
						@endif
						@if ($contribution)
						<li class="active"><a href="{{ site_url('account/contribution') }}">Contribution</a></li>
						@endif
						@if ($tax)
						<li class=""><a href="{{ site_url('account/tax') }}">Tax</a></li>
						@endif
						@if ($loan)
			...
			<div class="portlet-title">
				<div class="caption"><i class="fa {{ $mod->icon}}"></i>List of Contributions</div>
