                    ...
                    <div class="portlet-body form">
                            ...
                            <div class="form-body">
                            	...
                            	<div class="form-group">
                                    <label class="control-label col-md-4"> <?=lang('my_calendar.schedule')?> <span class="required">*</span></label>
                                    <div class="col-md-7">
                                        <select <?= $disabled?> id="scheduled" name="scheduled" class="form-control select2me" data-placeholder="Select...">
                                        	<option value="YES" <?php echo $scheduled == 'YES' ? "selected" : ""; ?>>Scheduled</option>
                                            <option value="NO" <?php echo $scheduled == 'NO' ? "selected" : ""; ?>>Unscheduled</option>
                                        </select>
                                        <div class="help-block small">
											<?=lang('my_calendar.select_st')?>
										</div>
                                    </div>
                                </div>
	                                <div class="form-group">
	                                ...
	                                <div class="form-group">
										...
										<div class="col-md-7">
											<div class="fileupload fileupload-new" data-provides="fileupload"  id="time_forms_upload-upload_id-container">
												<input <?= $disabled?> placeholder="sss" type="hidden" name="upload_id[]" id="time_forms_upload-upload_id" value="<?php echo implode(",", $upload_id['val']) ?>"/>
