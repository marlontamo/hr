                    ...
                    <div class="portlet-body form">
                            ...
                            <div class="form-body">
		                        ...
		                        <div class="form-group">
									<label class="control-label col-md-4"><?php echo lang('my_calendar.delivery') ?><span class="required">* </span></label>
									<div class="col-md-7">
										<?php	                            	                            		
						                            ...
						                            <?php echo form_dropdown('delivery_id',$time_delivery_delivery_id_options, $delivery_id['val'], 'id="time_forms_paternity-delivery_id" class="form-control select2me" data-placeholder="Select..."') ?>
						                        </div> 				</div>	
								</div>                            		
                                <div class="form-group">
