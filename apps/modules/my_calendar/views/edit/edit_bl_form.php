			...
			<div class="col-md-8">
				<div class="portlet">
                    <div class="portlet-body form">
                            ...
                            <input type="hidden" class="form-control" readonly id="date_to" name="date_to" value="<?php echo $date_to['val']; ?>">                            
                            <div class="form-body">
							    <div class="form-group">
							        <label class="control-label col-md-4"> <?=lang('my_calendar.type')?>: <span class="required">*</span></label>
							        <div class="col-md-7">
							            <select <?= $disabled?>  class="form-control select2me" data-placeholder="Select..." name="duration[]" id="duration[]" class="duration">
							                <?php foreach($duration as $val) {
							                     $selected_duration = ($bday_duration == $val['duration_id']) ? "selected" : "";
							                    ?>
							                <option value="<?php echo $val['duration_id']?>" <?php echo $selected_duration; ?> ><?=$val['duration']?></option>
							                <?php } ?>
							            </select>
							        </div>
							    </div>
