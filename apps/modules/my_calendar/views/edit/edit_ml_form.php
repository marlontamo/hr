                    ...
                    <div class="portlet-body form">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <textarea rows="4" class="form-control" id="reason" name="reason" ><?php echo $reason['val']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
										<label class="control-label col-md-4"><?=lang('my_calendar.uplaod_file')?></label>
										<div class="col-md-7">
...
<!-- 											<span class="fileupload-preview" style="margin-left:5px;"></span>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4"><?=lang('my_calendar.delivery')?><span class="required">*</span></label>
                                    <div class="col-md-7">
                                        <select <?= $disabled?> class="form-control select2me" data-placeholder="Select..." id="delivery_id" name="delivery_id" >
										<?php foreach($delivery as $index => $value){ 
					                    		$selected_delivery = ($value['delivery_id'] == $delivery_id['val']) ? "selected" : "";
					                    ?>
                                        	<option value="<?=$value['delivery_id']?>" <?php echo $selected_delivery; ?> ><?=$value['delivery']?></option>
										<?php } ?>
                                        </select>
                                    </div>
                                </div>	
                                <div class="form-group">
                                    <label class="control-label col-md-4"><?=lang('my_calendar.num_preg')?></label>
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" maxlength="25" name="pregnancy_no" id="pregnancy_no" placeholder="" readonly value="<?php if($pregnancy_no['val']>0) echo $pregnancy_no['val']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4"><?=lang('my_calendar.expected_delivery')?></label>
                                    <div class="col-md-7">
                                        <div class="input-group input-medium date date-picker related_dates" data-date-format="MM dd, yyyy">
                                            <input <?= $disabled?> name="expected_date" id="expected_date" type="text" class="form-control" value="<?php echo $expected_date['val']; ?>">
                                            <span class="input-group-btn">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4"><?=lang('my_calendar.actual_delivery')?></label>
                                    <div class="col-md-7">
                                        <div class="input-group input-medium date date-picker related_dates" data-date-format="MM dd, yyyy">
                                            <input <?= $disabled?> name="actual_date" id="actual_date" type="text" class="form-control" value="<?php echo $actual_date['val']; ?>">
                                            <span class="input-group-btn">
                                            <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                            </span>
                                        </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4"><?=lang('my_calendar.report_date')?></label>
                                    <div class="col-md-7">
                                        <div class="input-group input-medium date date-picker related_dates" data-date-format="MM dd, yyyy">
                                            <input <?= $disabled?> name="return_date" id="return_date" type="text" class="form-control" value="<?php echo $return_date['val']; ?>">
                                            <span class="input-group-btn">
                                            <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                            </span>
                                        </div>
	...
	$(document).ready(function(){
        ...
        *****/
		...
		if($('#form_status_id').val()>2){
   		...
   		//assign default maternity
   		if(!$('#forms_id').val() > 0){
	        set_date_to($('#delivery_id').val());
   		}
