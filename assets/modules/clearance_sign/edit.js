...
function add_sign( sign_id, properties_tag )
{
	...
	$.ajax({
	    ...
	    type: "POST",
	    async: false,
	    data: 'sign_id='+sign_id + '&record_id='+record_id + '&properties_tag='+properties_tag,
	    dataType: "json",
	    beforeSend: function () {
	        $.blockUI({
...
function save_sign( form, action, callback, properties_tag)
{
	$.blockUI({ message: saving_message(),
		onBlock: function(){
