...
function add_group()
{
    var unit_rate = $('input[name="payroll_entry_batch[unit_rate_main]"]').val();
    ...
    $.blockUI({ message: loading_message(), 
        onBlock: function(){
            ...
            $.ajax({
                ...
                type:"POST",
                data: {group: group, employee_id: employee_id, unit_rate: unit_rate},
                dataType: "json",
                async: false,
...
{
    $('input[name="payroll_entry_batch_employee[quantity][]"], input[name="payroll_entry_batch_employee[amount][]"]').die().keyup(function(){
...
{
    var amount = $('tr[employee_id="'+employee_id+'"] input[name="payroll_entry_batch_employee[amount][]"]').val();
    var quantity = $('tr[employee_id="'+employee_id+'"] input[name="payroll_entry_batch_employee[quantity][]"]').val();
    var total = 0;
    if( amount != "" && quantity != "" )
    {
    ...
    $('tr[employee_id="'+employee_id+'"] input[name="payroll_entry_batch_employee[total][]"]').attr('disabled', false);
    $('tr[employee_id="'+employee_id+'"] input[name="payroll_entry_batch_employee[total][]"]').val( parseFloat( total ).toFixed(2) );
    $('tr[employee_id="'+employee_id+'"] input[name="payroll_entry_batch_employee[total][]"]').attr('disabled', true);
}
   ...
   $('tbody#employee-lists').block({ message: '<img src="'+root_url+'assets/img/ajax-loading.gif" />',
        onBlock: function(){
            ...
            $.ajax({
                ...
                type:"POST",
                data: {employees: data, unit_rate: unit_rate},
                dataType: "json",
                async: false,
                success: function ( response ) {
                    handle_ajax_message( response.message );
