...
$('#users_company-company_id').change(function(){
    ...
    update_employees( $('#users_location-location_id').val(), $('#users_company-company_id').val(), $('#users_department-department_id').val() );
});
...
function update_employees( location_id, company_id, department_id )
{
    if( (location_id != "" && location_id != null) || ((company_id != "" && company_id != null) && (department_id != "" && department_id != null)) )
    {
