...
// A hack to make this work in CodeIgniter is to
// simply use the setup script below
/*
<script type="text/javascript" >
	jQuery(document).ready(function(){
		
		CKEDITOR.replace( 'memo[memo_body]',{
			...
			filebrowserImageUploadUrl : base_url + 'assets/plugins/ckfinder/core/connector/php/connector.php?base_url='+base_url+'&command=QuickUpload&type=Images',
...
if(isset($_GET['base_url'])){
	$baseUrl = $_GET['base_url'] . 'uploads/common_files/';	
}
else{
	// $upload_folder = array_reverse(explode ( '\\' , __dir__ ));

	// //$baseUrl = $_GET['base_url'] . 'uploads/common_files/';
	// $baseUrl = '/uploads/common_files/';
	// $baseUrl = '/'.$upload_folder[3].$baseUrl; 

	// $baseUrl = "D:\\www_root\\workwise_updated\\uploads\\common_files\\";

	$baseUrl = "http://".$_SERVER['HTTP_HOST'];
	$baseUrl .= $_SERVER['SCRIPT_NAME'];
	$baseUrl = array_shift(explode('assets', $baseUrl)) . 'uploads/common_files/';
